...
* [nushell](https://github.com/nushell/nushell) ⭐ 40,403 | 🐛 1,425 | 🌐 Rust | 📅 2026-09-02 - A modern shell written in Rust
...
* [ngs](https://github.com/ngs-lang/ngs) ⭐ 1,520 | 🐛 303 | 🌐 C | 📅 2026-09-02 - Fully featured scripting language created specifically for Ops. REPL is being developed.
* [ksh93](https://github.com/att/ast) ⚠️ Archived - Korn Shell
* [yash](https://github.com/magicant/yash) ⭐ 564 | 🐛 46 | 🌐 Shell | 📅 2026-09-01 - A POSIX-compliant command line shell with built-in support for completion and prediction based on command history
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 82,784 | 🐛 328 | 🌐 Go | 📅 2026-08-31 - A command-line fuzzy finder
* [rg](https://github.com/BurntSushi/ripgrep) ⭐ 67,875 | 🐛 185 | 🌐 Rust | 📅 2026-08-04 - ripgrep is a line oriented search tool that combines the usability of The Silver Searcher with the raw speed of GNU grep
* [fd](https://github.com/sharkdp/fd) ⭐ 44,288 | 🐛 199 | 🌐 Rust | 📅 2026-09-02 - A simple, fast and user-friendly alternative to find.
* [ag](https://github.com/ggreer/the_silver_searcher) ⭐ 27,113 | 🐛 564 | 🌐 C | 📅 2024-06-16 - Super fast string search through a directory hierarchy
* [nnn](https://github.com/jarun/nnn) ⭐ 21,854 | 🐛 6 | 🌐 C | 📅 2026-09-01 - File browser and disk usage analyzer with excellent desktop integration
* [browsh](https://github.com/browsh-org/browsh) ⭐ 19,022 | 🐛 241 | 🌐 JavaScript | 📅 2025-07-11 - The modern text-based browser
* [navi](https://github.com/denisidoro/navi) ⭐ 17,499 | 🐛 111 | 🌐 Rust | 📅 2026-07-28 - An interactive cheatsheet tool for the command-line
* [direnv](https://github.com/direnv/direnv) ⭐ 15,406 | 🐛 465 | 🌐 Go | 📅 2026-03-31 - An environment switcher for the shell, compare with autoenv
* [mackup](https://github.com/lra/mackup/) ⭐ 15,318 | 🐛 294 | 🌐 Python | 📅 2026-06-15 - Keep your application settings in sync (OS X/Linux)
* [broot](https://github.com/Canop/broot) ⭐ 12,927 | 🐛 233 | 🌐 Rust | 📅 2026-09-01 - A better way to navigate directories
...
* [Buku](https://github.com/jarun/Buku) ⭐ 7,188 | 🐛 6 | 🌐 Python | 📅 2026-08-16 - Powerful command-line bookmark manager
...
* [ddgr](https://github.com/jarun/ddgr) ⭐ 3,540 | 🐛 1 | 🌐 Python | 📅 2026-08-16 - DuckDuckGo from the terminal
...
* [k](https://github.com/supercrabtree/k) ⭐ 1,806 | 🐛 38 | 🌐 Shell | 📅 2023-02-04 - k is a Zsh script to make directory listings more readable, adding Git status, fileweight colors and rotting dates
...
* [eureka](https://github.com/simeg/eureka/) ⭐ 875 | 🐛 6 | 🌐 Rust | 📅 2026-08-28 - :bulb: CLI tool to input and store your ideas without leaving the terminal
...
* [cod](https://github.com/dim-an/cod) ⭐ 552 | 🐛 22 | 🌐 Go | 📅 2026-09-02 — A completion daemon for shell that learns when you invoke `--help` commands
...
* [thefuck](https://github.com/nvbn/thefuck) ⭐ 97,762 | 🐛 456 | 🌐 Python | 📅 2024-07-19 - Fix common shell mistakes by using an easy to remember command
...
* [wemux](https://github.com/zolrath/wemux) ⭐ 3,675 | 🐛 37 | 🌐 Shell | 📅 2022-10-03 - Multi-User Tmux Made Easy
...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 39,127 | 🐛 141 | 🌐 Rust | 📅 2026-08-31 - A faster way to navigate your filesystem, written in Rust
...
* [powerlevel10k](https://github.com/romkatv/powerlevel10k) ⭐ 55,017 | 🐛 150 | 🌐 Shell | 📅 2026-08-15 - Super flexible awesome powerline ZSH theme
* [Gogh - Color Scheme](https://github.com/Mayccoll/Gogh) ⭐ 10,301 | 🐛 3 | 🌐 Shell | 📅 2026-09-02 - Color Scheme for Gnome Terminal
...
* [just](https://github.com/casey/just) ⭐ 35,594 | 🐛 172 | 🌐 Rust | 📅 2026-09-01 - Task runner for saving and running project-specific commands.
* [dokku](https://github.com/dokku/dokku) ⭐ 32,122 | 🐛 42 | 🌐 Shell | 📅 2026-09-02 - Docker powered mini-Heroku. The smallest PaaS implementation you've ever seen.
* [cloc](https://github.com/AlDanial/cloc) ⭐ 23,493 | 🐛 26 | 🌐 Perl | 📅 2026-09-02 - Count Lines of Code
...
* [git-quick-stats](https://github.com/arzzen/git-quick-stats) ⭐ 7,001 | 🐛 3 | 🌐 Shell | 📅 2026-04-18 - Git quick statistics is a simple and efficient way to access various statistics in git repository.
...
* [forgit](https://github.com/wfxr/forgit) ⭐ 5,072 | 🐛 10 | 🌐 Shell | 📅 2026-09-01 - Utility tool for `git` taking advantage of fuzzy finder fzf.
...
* [git-open](https://github.com/paulirish/git-open) ⭐ 3,456 | 🐛 49 | 🌐 Shell | 📅 2026-05-25 - Type `git open` to open the GitHub page or website for a repository in your browser
* [gita](https://github.com/nosarthur/gita) ⭐ 1,934 | 🐛 36 | 🌐 Python | 📅 2026-07-06 - A command-line tool to manage multiple git repos.
* [git-extra-commands](https://github.com/unixorn/git-extra-commands) ⭐ 1,168 | 🐛 7 | 🌐 Shell | 📅 2026-08-31 - Many Git extra utilities. Churn, cut-branch, improved-merge and many more.
...
* [bitwise](https://github.com/mellowcandle/bitwise) ⭐ 721 | 🐛 12 | 🌐 C | 📅 2026-08-30 - Terminal based interactive bit manipulator in curses.
* [nve](https://github.com/ehmicky/nve) ⭐ 711 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-02 - Run any command on specific Node.js versions.
...
* [bat](https://github.com/sharkdp/bat) ⭐ 60,349 | 🐛 424 | 🌐 Rust | 📅 2026-09-01 - A `cat` clone with wings
* [btop](https://github.com/aristocratos/btop) ⭐ 34,373 | 🐛 532 | 🌐 C++ | 📅 2026-09-01 - Linux/OSX/FreeBSD resource monitor
* [glances](https://github.com/nicolargo/glances) ⭐ 33,509 | 🐛 102 | 🌐 Python | 📅 2026-08-30 - Glances an Eye on your system
* [exa](https://github.com/ogham/exa) ⭐ 24,443 | 🐛 213 | 🌐 Rust | 📅 2024-09-24 - A modern version of `ls`.
* [goaccess](https://github.com/allinurl/goaccess) ⭐ 20,894 | 🐛 449 | 🌐 C | 📅 2026-08-31 - GoAccess is a real-time web log analyzer and interactive viewer that runs in a terminal in \*nix systems.
* [lsd](https://github.com/Peltoche/lsd) ⭐ 16,206 | 🐛 205 | 🌐 Rust | 📅 2026-08-17 - LSDeluxe, rewrite of GNU ls with lot of added features like colors, icons, tree-view and more formatting options.
...
* [bmon](https://github.com/tgraf/bmon) ⭐ 1,386 | 🐛 38 | 🌐 C | 📅 2026-08-24 - Real-time network bandwidth monitor and rate estimator with human-friendly visual output
* [powertop](https://github.com/fenrus75/powertop) ⭐ 1,333 | 🐛 103 | 🌐 C++ | 📅 2026-09-01 - Battery/Power usage and device stats monitoring command-line tool, with tune-up options.
...
* [nmtui](https://github.com/NetworkManager/NetworkManager) ⭐ 506 | 🐛 2 | 🌐 C | 📅 2026-09-02 - Text User Interface for controlling NetworkManager
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 188,548 | 🐛 2,616 | 🌐 Python | 📅 2026-08-30 - Command-line program to download videos from YouTube.com and other video sites
* [aria2](https://github.com/aria2/aria2) ⭐ 41,900 | 🐛 1,175 | 🌐 C++ | 📅 2026-06-25 - aria2 is a lightweight multi-protocol & multi-source, cross platform download utility operated in command-line. It supports HTTP/HTTPS, FTP, BitTorrent and Metalink
* [httpie](https://github.com/httpie/httpie) ⭐ 38,479 | 🐛 335 | 🌐 Python | 📅 2024-12-17 - HTTPie is a command line HTTP client, a user-friendly cURL replacement
* [xh](https://github.com/ducaale/xh) ⭐ 8,050 | 🐛 38 | 🌐 Rust | 📅 2026-08-23 - Friendly and fast tool for sending HTTP requests
...
* [jq](https://github.com/stedolan/jq) ⭐ 35,530 | 🐛 475 | 🌐 C | 📅 2026-09-01 - Sed for json data. You can use it to slice and filter and map and transform structured data
* [fx](https://github.com/antonmedv/fx) ⭐ 20,617 | 🐛 27 | 🌐 Go | 📅 2026-08-26 - Command-line JSON processing tool by anononymus JavaScript functions
* [yq](https://github.com/mikefarah/yq) ⭐ 15,915 | 🐛 295 | 🌐 Go | 📅 2026-08-27 - yq is a portable command-line YAML processor
* [Beets](https://github.com/beetbox/beets) ⭐ 15,608 | 🐛 716 | 🌐 Python | 📅 2026-09-02 - Music library manager and MusicBrainz tagger
* [visidata](https://github.com/saulpw/visidata) ⭐ 9,263 | 🐛 80 | 🌐 Python | 📅 2026-08-28 - A terminal spreadsheet multitool for exploring and arranging data (csv/json/xml/xls/yaml/etc)
...
* [wttr.in](https://github.com/chubin/wttr.in) ⭐ 30,476 | 🐛 330 | 🌐 Go | 📅 2026-08-02 - :partly\_sunny: The right way to check the weather (curl wttr.in)
* [ranger](https://github.com/ranger/ranger) ⭐ 17,385 | 🐛 896 | 🌐 Python | 📅 2026-08-31 - A console file manager with VI key bindings.
...
* [jrnl](https://github.com/jrnl-org/jrnl) ⭐ 7,306 | 🐛 151 | 🌐 Python | 📅 2026-08-31 - A simple command line journal application that stores your journal in a plain text file
...
* [editly](https://github.com/mifi/editly) ⭐ 5,482 | 🐛 80 | 🌐 TypeScript | 📅 2025-05-12 - Command line video editor
...
* [shellcheck](https://github.com/koalaman/shellcheck) ⭐ 39,979 | 🐛 1,138 | 🌐 Haskell | 📅 2026-08-04 - Static analysis tool for shell scripts
* [shfmt](https://github.com/mvdan/sh) ⭐ 9,034 | 🐛 94 | 🌐 Go | 📅 2026-08-31 - A shell parser, formatter, and interpreter with bash support; includes shfmt
* [bats](https://github.com/bats-core/bats-core) ⭐ 6,243 | 🐛 127 | 🌐 Shell | 📅 2026-07-26 - Bash Automated Testing System
* [bash-language-server](https://github.com/bash-lsp/bash-language-server) ⭐ 2,776 | 🐛 135 | 🌐 TypeScript | 📅 2026-09-01 - [LSP](https://microsoft.github.io/language-server-protocol/)-based Bash language server
...
* [zunit](https://github.com/zunit-zsh/zunit) ⭐ 226 | 🐛 18 | 🌐 Shell | 📅 2026-09-02 - A powerful unit testing framework for ZSH
...
* [The Art of Command Line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,213 | 🐛 257 | 📅 2024-06-25
* [A guide to learn bash](https://github.com/Idnan/bash-guide) ⭐ 12,374 | 🐛 27 | 📅 2024-08-11
...
Other amazingly awesome lists can be found in [awesome-awesome](https://github.com/emijrp/awesome-awesome) ⭐ 3,205 | 🐛 26 | 📅 2024-07-31 and [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,643 | 🐛 62 | 🌐 Ruby | 📅 2024-06-02.

### See also

* [awesome-cli-apps](https://github.com/agarrharr/awesome-cli-apps) ⭐ 20,306 | 🐛 0 | 🌐 Shell | 📅 2026-09-02
* [terminals-are-sexy](https://github.com/k4m4/terminals-are-sexy) ⭐ 13,107 | 🐛 150 | 🌐 Shell | 📅 2024-07-26
