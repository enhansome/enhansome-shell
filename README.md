...
* [nushell](https://github.com/nushell/nushell) ⭐ 40,514 | 🐛 1,440 | 🌐 Rust | 📅 2026-09-14 - A modern shell written in Rust
...
* [yash](https://github.com/magicant/yash) ⭐ 568 | 🐛 45 | 🌐 Shell | 📅 2026-09-12 - A POSIX-compliant command line shell with built-in support for completion and prediction based on command history
...
* [rg](https://github.com/BurntSushi/ripgrep) ⭐ 68,297 | 🐛 196 | 🌐 Rust | 📅 2026-08-04 - ripgrep is a line oriented search tool that combines the usability of The Silver Searcher with the raw speed of GNU grep
...
* [nnn](https://github.com/jarun/nnn) ⭐ 21,883 | 🐛 4 | 🌐 C | 📅 2026-09-15 - File browser and disk usage analyzer with excellent desktop integration
* [browsh](https://github.com/browsh-org/browsh) ⭐ 19,043 | 🐛 241 | 🌐 JavaScript | 📅 2025-07-11 - The modern text-based browser
* [navi](https://github.com/denisidoro/navi) ⭐ 17,551 | 🐛 111 | 🌐 Rust | 📅 2026-09-15 - An interactive cheatsheet tool for the command-line
* [direnv](https://github.com/direnv/direnv) ⭐ 15,447 | 🐛 468 | 🌐 Go | 📅 2026-03-31 - An environment switcher for the shell, compare with autoenv
* [mackup](https://github.com/lra/mackup/) ⭐ 15,322 | 🐛 294 | 🌐 Python | 📅 2026-09-09 - Keep your application settings in sync (OS X/Linux)
* [broot](https://github.com/Canop/broot) ⭐ 12,940 | 🐛 100 | 🌐 Rust | 📅 2026-09-13 - A better way to navigate directories
* [lf](https://github.com/gokcehan/lf) ⭐ 9,512 | 🐛 84 | 🌐 Go | 📅 2026-09-15 - Terminal file manager written in Go, inspired by ranger
* [mcfly](https://github.com/cantino/mcfly) ⭐ 7,793 | 🐛 135 | 🌐 Rust | 📅 2026-09-01 - Fly through your shell history. Great Scot!
...
* [hstr](https://github.com/dvorka/hstr) ⭐ 4,460 | 🐛 186 | 🌐 C | 📅 2026-09-11 - Bash History Suggest Box
* [fselect](https://github.com/jhspetersson/fselect) ⭐ 4,457 | 🐛 6 | 🌐 Rust | 📅 2026-09-05 - Find files with SQL-like queries.
* [ddgr](https://github.com/jarun/ddgr) ⭐ 3,553 | 🐛 1 | 🌐 Python | 📅 2026-08-16 - DuckDuckGo from the terminal
...
* [bashhub](https://github.com/rcaloras/bashhub-client) ⭐ 1,306 | 🐛 24 | 🌐 Python | 📅 2026-08-30 - :cloud: Bash history in the cloud. Indexed and searchable.
...
* [eureka](https://github.com/simeg/eureka/) ⭐ 879 | 🐛 6 | 🌐 Rust | 📅 2026-08-28 - :bulb: CLI tool to input and store your ideas without leaving the terminal
* [bartib](https://github.com/nikolassv/bartib) ⭐ 847 | 🐛 19 | 🌐 Rust | 📅 2026-03-25 - A simple timetracker for the command line. It saves a log of all tracked activities as a plaintext file and allows you to create flexible reports.
* [has](https://github.com/kdabir/has) ⭐ 820 | 🐛 14 | 🌐 Shell | 📅 2026-09-11 - `has` helps you check presence of various command line tools and their versions on path
...
* [thefuck](https://github.com/nvbn/thefuck) ⭐ 97,850 | 🐛 457 | 🌐 Python | 📅 2024-07-19 - Fix common shell mistakes by using an easy to remember command
* [xsv](https://github.com/BurntSushi/xsv) ⚠️ Archived - a fast CSV command line toolkit written in Rust
* [usql](https://github.com/xo/usql) ⭐ 10,115 | 🐛 122 | 🌐 Go | 📅 2026-09-13 - Universal command-line interface for SQL databases.
* [xxh](https://github.com/xxh/xxh) ⭐ 6,090 | 🐛 30 | 🌐 Python | 📅 2026-06-02 - Bring your favorite shell wherever you go through the SSH.
* [xplr](https://github.com/sayanarijit/xplr) ⭐ 4,822 | 🐛 12 | 🌐 Rust | 📅 2026-09-15 -  A hackable, minimal, fast TUI file explorer
...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 39,485 | 🐛 146 | 🌐 Rust | 📅 2026-09-14 - A faster way to navigate your filesystem, written in Rust
* [z](https://github.com/rupa/z) ⭐ 17,048 | 🐛 109 | 🌐 Shell | 📅 2024-06-19 - z is the new j, yo
...
* [powerlevel10k](https://github.com/romkatv/powerlevel10k) ⭐ 55,102 | 🐛 150 | 🌐 Shell | 📅 2026-09-14 - Super flexible awesome powerline ZSH theme
* [Gogh - Color Scheme](https://github.com/Mayccoll/Gogh) ⭐ 10,313 | 🐛 7 | 🌐 Shell | 📅 2026-09-15 - Color Scheme for Gnome Terminal
...
* [just](https://github.com/casey/just) ⭐ 35,806 | 🐛 171 | 🌐 Rust | 📅 2026-09-01 - Task runner for saving and running project-specific commands.
* [dokku](https://github.com/dokku/dokku) ⭐ 32,141 | 🐛 40 | 🌐 Shell | 📅 2026-09-15 - Docker powered mini-Heroku. The smallest PaaS implementation you've ever seen.
* [cloc](https://github.com/AlDanial/cloc) ⭐ 23,534 | 🐛 27 | 🌐 Perl | 📅 2026-09-14 - Count Lines of Code
* [hub](https://github.com/github/hub) ⭐ 22,953 | 🐛 295 | 🌐 Go | 📅 2024-02-02 - hub helps you win at git.
* [git-extras](https://github.com/tj/git-extras) ⭐ 18,106 | 🐛 97 | 🌐 Shell | 📅 2026-09-01 - Git utilities -- repo summary, repl, changelog population, author commit percentages and more
* [bocker](https://github.com/p8952/bocker) ⭐ 12,678 | 🐛 15 | 🌐 Shell | 📅 2017-12-09 - Docker implemented in 100 lines of bash
...
* [gita](https://github.com/nosarthur/gita) ⭐ 1,938 | 🐛 36 | 🌐 Python | 📅 2026-07-06 - A command-line tool to manage multiple git repos.
* [git-extra-commands](https://github.com/unixorn/git-extra-commands) ⭐ 1,171 | 🐛 8 | 🌐 Shell | 📅 2026-09-14 - Many Git extra utilities. Churn, cut-branch, improved-merge and many more.
...
* [bat](https://github.com/sharkdp/bat) ⭐ 60,463 | 🐛 520 | 🌐 Rust | 📅 2026-09-04 - A `cat` clone with wings
* [btop](https://github.com/aristocratos/btop) ⭐ 34,590 | 🐛 539 | 🌐 C++ | 📅 2026-09-09 - Linux/OSX/FreeBSD resource monitor
...
* [goaccess](https://github.com/allinurl/goaccess) ⭐ 20,928 | 🐛 449 | 🌐 C | 📅 2026-09-13 - GoAccess is a real-time web log analyzer and interactive viewer that runs in a terminal in \*nix systems.
* [lsd](https://github.com/Peltoche/lsd) ⭐ 16,222 | 🐛 208 | 🌐 Rust | 📅 2026-08-17 - LSDeluxe, rewrite of GNU ls with lot of added features like colors, icons, tree-view and more formatting options.
...
* [mtr](https://github.com/traviscross/mtr) ⭐ 3,342 | 🐛 140 | 🌐 C | 📅 2026-06-16 - The functionality of the 'traceroute' and 'ping' programs in a single network diagnostic tool.
...
* [bmon](https://github.com/tgraf/bmon) ⭐ 1,388 | 🐛 38 | 🌐 C | 📅 2026-09-15 - Real-time network bandwidth monitor and rate estimator with human-friendly visual output
...
* [nmtui](https://github.com/NetworkManager/NetworkManager) ⭐ 507 | 🐛 0 | 🌐 C | 📅 2026-09-13 - Text User Interface for controlling NetworkManager
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 191,401 | 🐛 2,652 | 🌐 Python | 📅 2026-08-30 - Command-line program to download videos from YouTube.com and other video sites
* [aria2](https://github.com/aria2/aria2) ⭐ 42,357 | 🐛 1,178 | 🌐 C++ | 📅 2026-06-25 - aria2 is a lightweight multi-protocol & multi-source, cross platform download utility operated in command-line. It supports HTTP/HTTPS, FTP, BitTorrent and Metalink
* [httpie](https://github.com/httpie/httpie) ⭐ 38,517 | 🐛 338 | 🌐 Python | 📅 2024-12-17 - HTTPie is a command line HTTP client, a user-friendly cURL replacement
* [xh](https://github.com/ducaale/xh) ⭐ 8,073 | 🐛 37 | 🌐 Rust | 📅 2026-09-05 - Friendly and fast tool for sending HTTP requests
...
* [jq](https://github.com/stedolan/jq) ⭐ 35,607 | 🐛 479 | 🌐 C | 📅 2026-09-15 - Sed for json data. You can use it to slice and filter and map and transform structured data
* [fx](https://github.com/antonmedv/fx) ⭐ 20,624 | 🐛 32 | 🌐 Go | 📅 2026-08-26 - Command-line JSON processing tool by anononymus JavaScript functions
* [yq](https://github.com/mikefarah/yq) ⭐ 15,962 | 🐛 298 | 🌐 Go | 📅 2026-09-15 - yq is a portable command-line YAML processor
* [Beets](https://github.com/beetbox/beets) ⭐ 15,664 | 🐛 715 | 🌐 Python | 📅 2026-09-15 - Music library manager and MusicBrainz tagger
* [visidata](https://github.com/saulpw/visidata) ⭐ 9,279 | 🐛 89 | 🌐 Python | 📅 2026-08-28 - A terminal spreadsheet multitool for exploring and arranging data (csv/json/xml/xls/yaml/etc)
* [jc](https://github.com/kellyjonbrazil/jc) ⭐ 8,678 | 🐛 44 | 🌐 Python | 📅 2026-09-15 - Convert command output, file-types, and common strings to JSON or YAML for easier use in scripts.
* [dasel](https://github.com/tomwright/dasel) ⭐ 8,033 | 🐛 25 | 🌐 Go | 📅 2026-08-16 - Query and update data structures using selectors from the command line. Comparable to [jq](https://github.com/stedolan/jq) ⭐ 35,607 | 🐛 479 | 🌐 C | 📅 2026-09-15 / [yq](https://github.com/kislyuk/yq) ⭐ 2,975 | 🐛 23 | 🌐 Python | 📅 2026-07-11 but supports JSON, YAML, TOML and XML with zero runtime dependencies.
...
* [PiCAST](https://github.com/lanceseidman/PiCAST) ⭐ 1,797 | 🐛 26 | 🌐 Shell | 📅 2026-03-28 - PiCAST turns your $35 Raspberry Pi in to a Chromecast like Device
...
* [xidel](https://github.com/benibela/xidel/) ⭐ 845 | 🐛 26 | 🌐 Pascal | 📅 2025-02-22 - Cli tool to filter, map and create HTML/XML/JSON data with (Turing-complete) XPath and XQuery.
...
* [wttr.in](https://github.com/chubin/wttr.in) ⭐ 30,538 | 🐛 331 | 🌐 Go | 📅 2026-09-07 - :partly\_sunny: The right way to check the weather (curl wttr.in)
...
* [ledger](https://github.com/ledger/ledger) ⭐ 6,035 | 🐛 19 | 🌐 C++ | 📅 2026-09-05 - Command line accounting
...
* [editly](https://github.com/mifi/editly) ⭐ 5,501 | 🐛 80 | 🌐 TypeScript | 📅 2025-05-12 - Command line video editor
...
* [gcalcli](https://github.com/insanum/gcalcli) ⭐ 3,763 | 🐛 170 | 🌐 Python | 📅 2025-10-25 - Google Calendar command line interface
...
* [bashblog](https://github.com/cfenollosa/bashblog) ⭐ 1,927 | 🐛 35 | 🌐 Shell | 📅 2026-07-09 - A Bash script that handles blog posting
* [fanyi](https://github.com/afc163/fanyi) ⭐ 1,553 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-07 - Translate English to Chinese in terminal
* [dstask](https://github.com/naggie/dstask) ⭐ 1,202 | 🐛 44 | 🌐 Go | 📅 2026-05-11 - Single binary terminal-based TODO manager with git-based sync + markdown notes per task
...
* [dotdrop](https://github.com/deadc0de6/dotdrop) ⭐ 1,948 | 🐛 0 | 🌐 Python | 📅 2026-09-09 - Save your dotfiles once, deploy them everywhere
...
* [shellcheck](https://github.com/koalaman/shellcheck) ⭐ 40,041 | 🐛 1,140 | 🌐 Haskell | 📅 2026-08-04 - Static analysis tool for shell scripts
* [shfmt](https://github.com/mvdan/sh) ⭐ 9,059 | 🐛 93 | 🌐 Go | 📅 2026-09-09 - A shell parser, formatter, and interpreter with bash support; includes shfmt
* [bats](https://github.com/bats-core/bats-core) ⭐ 6,260 | 🐛 126 | 🌐 Shell | 📅 2026-09-13 - Bash Automated Testing System
* [bash-language-server](https://github.com/bash-lsp/bash-language-server) ⭐ 2,778 | 🐛 137 | 🌐 TypeScript | 📅 2026-09-15 - [LSP](https://microsoft.github.io/language-server-protocol/)-based Bash language server
...
* [ansi](https://github.com/fidian/ansi) ⭐ 842 | 🐛 2 | 🌐 Shell | 📅 2021-11-28 - ANSI escape codes in pure bash - change text color, position the cursor, much more
...
* [The Art of Command Line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,406 | 🐛 256 | 📅 2024-06-25
* [A guide to learn bash](https://github.com/Idnan/bash-guide) ⭐ 12,378 | 🐛 27 | 📅 2024-08-11
...
Other amazingly awesome lists can be found in [awesome-awesome](https://github.com/emijrp/awesome-awesome) ⭐ 3,208 | 🐛 26 | 📅 2024-07-31 and [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,674 | 🐛 65 | 🌐 Ruby | 📅 2024-06-02.

### See also

* [awesome-cli-apps](https://github.com/agarrharr/awesome-cli-apps) ⭐ 20,400 | 🐛 0 | 🌐 Shell | 📅 2026-09-13
* [terminals-are-sexy](https://github.com/k4m4/terminals-are-sexy) ⭐ 13,113 | 🐛 153 | 🌐 Shell | 📅 2024-07-26
