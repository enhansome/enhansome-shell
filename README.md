...
* [nushell](https://github.com/nushell/nushell) ⭐ 40,532 | 🐛 1,441 | 🌐 Rust | 📅 2026-09-19 - A modern shell written in Rust
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 83,150 | 🐛 330 | 🌐 Go | 📅 2026-09-14 - A command-line fuzzy finder
* [rg](https://github.com/BurntSushi/ripgrep) ⭐ 68,469 | 🐛 201 | 🌐 Rust | 📅 2026-08-04 - ripgrep is a line oriented search tool that combines the usability of The Silver Searcher with the raw speed of GNU grep
...
* [nnn](https://github.com/jarun/nnn) ⭐ 21,970 | 🐛 2 | 🌐 C | 📅 2026-09-19 - File browser and disk usage analyzer with excellent desktop integration
* [browsh](https://github.com/browsh-org/browsh) ⭐ 19,053 | 🐛 241 | 🌐 JavaScript | 📅 2025-07-11 - The modern text-based browser
* [navi](https://github.com/denisidoro/navi) ⭐ 17,588 | 🐛 110 | 🌐 Rust | 📅 2026-09-20 - An interactive cheatsheet tool for the command-line
* [direnv](https://github.com/direnv/direnv) ⭐ 15,456 | 🐛 468 | 🌐 Go | 📅 2026-03-31 - An environment switcher for the shell, compare with autoenv
* [mackup](https://github.com/lra/mackup/) ⭐ 15,327 | 🐛 294 | 🌐 Python | 📅 2026-09-09 - Keep your application settings in sync (OS X/Linux)
* [broot](https://github.com/Canop/broot) ⭐ 12,949 | 🐛 100 | 🌐 Rust | 📅 2026-09-20 - A better way to navigate directories
* [lf](https://github.com/gokcehan/lf) ⭐ 9,518 | 🐛 85 | 🌐 Go | 📅 2026-09-15 - Terminal file manager written in Go, inspired by ranger
* [mcfly](https://github.com/cantino/mcfly) ⭐ 7,799 | 🐛 135 | 🌐 Rust | 📅 2026-09-01 - Fly through your shell history. Great Scot!
...
* [hstr](https://github.com/dvorka/hstr) ⭐ 4,463 | 🐛 186 | 🌐 C | 📅 2026-09-16 - Bash History Suggest Box
* [ddgr](https://github.com/jarun/ddgr) ⭐ 3,558 | 🐛 1 | 🌐 Python | 📅 2026-08-16 - DuckDuckGo from the terminal
...
* [thefuck](https://github.com/nvbn/thefuck) ⭐ 97,860 | 🐛 458 | 🌐 Python | 📅 2024-07-19 - Fix common shell mistakes by using an easy to remember command
...
* [xxh](https://github.com/xxh/xxh) ⭐ 6,094 | 🐛 30 | 🌐 Python | 📅 2026-06-02 - Bring your favorite shell wherever you go through the SSH.
...
* [wemux](https://github.com/zolrath/wemux) ⭐ 3,695 | 🐛 37 | 🌐 Shell | 📅 2022-10-03 - Multi-User Tmux Made Easy
...
* [undollar](https://github.com/xtyrrell/undollar) ⭐ 208 | 🐛 2 | 🌐 JavaScript | 📅 2018-09-14 - undollar bites the dollar sign off the tip of the command you just pasted into your terminal
...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 39,621 | 🐛 146 | 🌐 Rust | 📅 2026-09-14 - A faster way to navigate your filesystem, written in Rust
...
* [powerlevel10k](https://github.com/romkatv/powerlevel10k) ⭐ 55,129 | 🐛 152 | 🌐 Shell | 📅 2026-09-14 - Super flexible awesome powerline ZSH theme
* [Gogh - Color Scheme](https://github.com/Mayccoll/Gogh) ⭐ 10,317 | 🐛 7 | 🌐 Shell | 📅 2026-09-18 - Color Scheme for Gnome Terminal
...
* [just](https://github.com/casey/just) ⭐ 35,923 | 🐛 171 | 🌐 Rust | 📅 2026-09-01 - Task runner for saving and running project-specific commands.
* [dokku](https://github.com/dokku/dokku) ⭐ 32,148 | 🐛 29 | 🌐 Go | 📅 2026-09-20 - Docker powered mini-Heroku. The smallest PaaS implementation you've ever seen.
* [cloc](https://github.com/AlDanial/cloc) ⭐ 23,549 | 🐛 26 | 🌐 Perl | 📅 2026-09-20 - Count Lines of Code
* [hub](https://github.com/github/hub) ⭐ 22,954 | 🐛 296 | 🌐 Go | 📅 2024-02-02 - hub helps you win at git.
* [git-extras](https://github.com/tj/git-extras) ⭐ 18,106 | 🐛 95 | 🌐 Shell | 📅 2026-09-20 - Git utilities -- repo summary, repl, changelog population, author commit percentages and more
...
* [forgit](https://github.com/wfxr/forgit) ⭐ 5,081 | 🐛 7 | 🌐 Shell | 📅 2026-09-17 - Utility tool for `git` taking advantage of fuzzy finder fzf.
...
* [git-open](https://github.com/paulirish/git-open) ⭐ 3,460 | 🐛 50 | 🌐 Shell | 📅 2026-05-25 - Type `git open` to open the GitHub page or website for a repository in your browser
* [gita](https://github.com/nosarthur/gita) ⭐ 1,941 | 🐛 36 | 🌐 Python | 📅 2026-07-06 - A command-line tool to manage multiple git repos.
* [git-extra-commands](https://github.com/unixorn/git-extra-commands) ⭐ 1,172 | 🐛 2 | 🌐 Shell | 📅 2026-09-20 - Many Git extra utilities. Churn, cut-branch, improved-merge and many more.
...
* [vmn](https://github.com/final-israel/vmn) ⭐ 65 | 🐛 41 | 🌐 Python | 📅 2026-09-20 - git-based automatic versioning and state recovery solution agnostic to language or architecture
...
* [bat](https://github.com/sharkdp/bat) ⭐ 60,511 | 🐛 518 | 🌐 Rust | 📅 2026-09-04 - A `cat` clone with wings
* [btop](https://github.com/aristocratos/btop) ⭐ 34,674 | 🐛 542 | 🌐 C++ | 📅 2026-09-19 - Linux/OSX/FreeBSD resource monitor
* [glances](https://github.com/nicolargo/glances) ⭐ 33,625 | 🐛 103 | 🌐 Python | 📅 2026-09-20 - Glances an Eye on your system
...
* [lsd](https://github.com/Peltoche/lsd) ⭐ 16,235 | 🐛 210 | 🌐 Rust | 📅 2026-08-17 - LSDeluxe, rewrite of GNU ls with lot of added features like colors, icons, tree-view and more formatting options.
* [progress](https://github.com/Xfennec/progress) ⭐ 8,855 | 🐛 66 | 🌐 C | 📅 2024-11-19 - Linux tool to show progress for `cp`, `rm`, `dd`, and more...
* [htop](https://github.com/hishamhm/htop) ⚠️ Archived - A ncurses based interactive process viewer which aims to be a better `top`
* [mtr](https://github.com/traviscross/mtr) ⭐ 3,345 | 🐛 141 | 🌐 C | 📅 2026-06-16 - The functionality of the 'traceroute' and 'ping' programs in a single network diagnostic tool.
...
* [bmon](https://github.com/tgraf/bmon) ⭐ 1,389 | 🐛 37 | 🌐 C | 📅 2026-09-19 - Real-time network bandwidth monitor and rate estimator with human-friendly visual output
...
* [wifi-wand](https://github.com/keithrbennett/wifiwand) ⭐ 80 | 🐛 3 | 🌐 Ruby | 📅 2026-09-20 - a Ruby command line application for managing WiFi on MacOS (install by `gem install wifi-wand`)
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 192,326 | 🐛 2,663 | 🌐 Python | 📅 2026-09-16 - Command-line program to download videos from YouTube.com and other video sites
* [aria2](https://github.com/aria2/aria2) ⭐ 42,563 | 🐛 1,178 | 🌐 C++ | 📅 2026-06-25 - aria2 is a lightweight multi-protocol & multi-source, cross platform download utility operated in command-line. It supports HTTP/HTTPS, FTP, BitTorrent and Metalink
* [httpie](https://github.com/httpie/httpie) ⭐ 38,560 | 🐛 338 | 🌐 Python | 📅 2024-12-17 - HTTPie is a command line HTTP client, a user-friendly cURL replacement
* [xh](https://github.com/ducaale/xh) ⭐ 8,086 | 🐛 37 | 🌐 Rust | 📅 2026-09-05 - Friendly and fast tool for sending HTTP requests
* [Dropbox-Uploader](https://github.com/andreafabrizi/Dropbox-Uploader) ⭐ 6,599 | 🐛 162 | 🌐 Shell | 📅 2024-06-04 - Dropbox Uploader is a Bash script which can be used to upload, download, list or delete files from Dropbox
...
* [jq](https://github.com/stedolan/jq) ⭐ 35,647 | 🐛 450 | 🌐 C | 📅 2026-09-19 - Sed for json data. You can use it to slice and filter and map and transform structured data
* [fx](https://github.com/antonmedv/fx) ⭐ 20,634 | 🐛 33 | 🌐 Go | 📅 2026-08-26 - Command-line JSON processing tool by anononymus JavaScript functions
* [yq](https://github.com/mikefarah/yq) ⭐ 15,986 | 🐛 304 | 🌐 Go | 📅 2026-09-17 - yq is a portable command-line YAML processor
* [Beets](https://github.com/beetbox/beets) ⭐ 15,680 | 🐛 710 | 🌐 Python | 📅 2026-09-20 - Music library manager and MusicBrainz tagger
* [visidata](https://github.com/saulpw/visidata) ⭐ 9,288 | 🐛 89 | 🌐 Python | 📅 2026-09-17 - A terminal spreadsheet multitool for exploring and arranging data (csv/json/xml/xls/yaml/etc)
* [jc](https://github.com/kellyjonbrazil/jc) ⭐ 8,680 | 🐛 27 | 🌐 Python | 📅 2026-09-19 - Convert command output, file-types, and common strings to JSON or YAML for easier use in scripts.
* [dasel](https://github.com/tomwright/dasel) ⭐ 8,039 | 🐛 25 | 🌐 Go | 📅 2026-08-16 - Query and update data structures using selectors from the command line. Comparable to [jq](https://github.com/stedolan/jq) ⭐ 35,647 | 🐛 450 | 🌐 C | 📅 2026-09-19 / [yq](https://github.com/kislyuk/yq) ⭐ 2,981 | 🐛 22 | 🌐 Python | 📅 2026-09-19 but supports JSON, YAML, TOML and XML with zero runtime dependencies.
* [cmus](https://github.com/cmus/cmus) ⭐ 6,246 | 🐛 219 | 🌐 C | 📅 2026-08-12 - Cross-platform cli audio player.
...
* [wttr.in](https://github.com/chubin/wttr.in) ⭐ 30,569 | 🐛 331 | 🌐 Go | 📅 2026-09-07 - :partly\_sunny: The right way to check the weather (curl wttr.in)
...
* [editly](https://github.com/mifi/editly) ⭐ 5,506 | 🐛 80 | 🌐 TypeScript | 📅 2025-05-12 - Command line video editor
...
* [bash-it](https://github.com/Bash-it/bash-it) ⭐ 15,193 | 🐛 6 | 🌐 Shell | 📅 2026-09-13 - A community Bash framework
...
* [shellcheck](https://github.com/koalaman/shellcheck) ⭐ 40,059 | 🐛 1,137 | 🌐 Haskell | 📅 2026-09-17 - Static analysis tool for shell scripts
* [shfmt](https://github.com/mvdan/sh) ⭐ 9,068 | 🐛 93 | 🌐 Go | 📅 2026-09-09 - A shell parser, formatter, and interpreter with bash support; includes shfmt
* [bats](https://github.com/bats-core/bats-core) ⭐ 6,274 | 🐛 129 | 🌐 Shell | 📅 2026-09-16 - Bash Automated Testing System
* [bash-language-server](https://github.com/bash-lsp/bash-language-server) ⭐ 2,780 | 🐛 66 | 🌐 TypeScript | 📅 2026-09-20 - [LSP](https://microsoft.github.io/language-server-protocol/)-based Bash language server
...
* [The Art of Command Line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,468 | 🐛 256 | 📅 2024-06-25
...
Other amazingly awesome lists can be found in [awesome-awesome](https://github.com/emijrp/awesome-awesome) ⭐ 3,210 | 🐛 26 | 📅 2024-07-31 and [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,681 | 🐛 65 | 🌐 Ruby | 📅 2024-06-02.
