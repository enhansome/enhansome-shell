...
* [nushell](https://github.com/nushell/nushell) ⭐ 40,271 | 🐛 1,417 | 🌐 Rust | 📅 2026-08-16 - A modern shell written in Rust
* [murex](https://github.com/lmorg/murex) ⭐ 1,904 | 🐛 84 | 🌐 Go | 📅 2026-07-29 - A smarter shell and scripting environment with advanced features designed for usability, safety and productivity (eg smarter DevOps tooling)
...
* [yash](https://github.com/magicant/yash) ⭐ 557 | 🐛 42 | 🌐 Shell | 📅 2026-08-16 - A POSIX-compliant command line shell with built-in support for completion and prediction based on command history
* [oksh](https://github.com/ibara/oksh) ⭐ 452 | 🐛 17 | 🌐 C | 📅 2026-06-10 - Portable OpenBSD ksh
* [es](https://wryun.github.io/es-shell/) - The extensible shell, based on Plan 9's [rc](https://github.com/rakitzis/rc) ⭐ 327 | 🐛 10 | 🌐 C | 📅 2026-04-24 shell
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 82,543 | 🐛 327 | 🌐 Go | 📅 2026-08-14 - A command-line fuzzy finder
* [rg](https://github.com/BurntSushi/ripgrep) ⭐ 67,326 | 🐛 176 | 🌐 Rust | 📅 2026-08-04 - ripgrep is a line oriented search tool that combines the usability of The Silver Searcher with the raw speed of GNU grep
* [fd](https://github.com/sharkdp/fd) ⭐ 44,103 | 🐛 188 | 🌐 Rust | 📅 2026-08-11 - A simple, fast and user-friendly alternative to find.
* [ag](https://github.com/ggreer/the_silver_searcher) ⭐ 27,103 | 🐛 564 | 🌐 C | 📅 2024-06-16 - Super fast string search through a directory hierarchy
* [nnn](https://github.com/jarun/nnn) ⭐ 21,794 | 🐛 4 | 🌐 C | 📅 2026-08-16 - File browser and disk usage analyzer with excellent desktop integration
* [browsh](https://github.com/browsh-org/browsh) ⭐ 18,983 | 🐛 241 | 🌐 JavaScript | 📅 2025-07-11 - The modern text-based browser
* [navi](https://github.com/denisidoro/navi) ⭐ 17,444 | 🐛 110 | 🌐 Rust | 📅 2026-07-28 - An interactive cheatsheet tool for the command-line
* [direnv](https://github.com/direnv/direnv) ⭐ 15,361 | 🐛 458 | 🌐 Go | 📅 2026-03-31 - An environment switcher for the shell, compare with autoenv
* [mackup](https://github.com/lra/mackup/) ⭐ 15,306 | 🐛 295 | 🌐 Python | 📅 2026-06-15 - Keep your application settings in sync (OS X/Linux)
* [broot](https://github.com/Canop/broot) ⭐ 12,894 | 🐛 243 | 🌐 Rust | 📅 2026-08-16 - A better way to navigate directories
* [lf](https://github.com/gokcehan/lf) ⭐ 9,468 | 🐛 81 | 🌐 Go | 📅 2026-08-15 - Terminal file manager written in Go, inspired by ranger
* [mcfly](https://github.com/cantino/mcfly) ⭐ 7,778 | 🐛 135 | 🌐 Rust | 📅 2026-04-14 - Fly through your shell history. Great Scot!
* [Buku](https://github.com/jarun/Buku) ⭐ 7,178 | 🐛 6 | 🌐 Python | 📅 2026-08-16 - Powerful command-line bookmark manager
...
* [how2](https://github.com/santinic/how2) ⭐ 5,774 | 🐛 6 | 🌐 JavaScript | 📅 2023-03-15 - `how2` finds the simplest way to do something in a unix shell. It's like `man`, but you can query it in natural language.
...
* [hstr](https://github.com/dvorka/hstr) ⭐ 4,448 | 🐛 185 | 🌐 C | 📅 2026-05-29 - Bash History Suggest Box
* [ddgr](https://github.com/jarun/ddgr) ⭐ 3,526 | 🐛 1 | 🌐 Python | 📅 2026-08-16 - DuckDuckGo from the terminal
...
* [thefuck](https://github.com/nvbn/thefuck) ⭐ 97,711 | 🐛 454 | 🌐 Python | 📅 2024-07-19 - Fix common shell mistakes by using an easy to remember command
* [xsv](https://github.com/BurntSushi/xsv) ⚠️ Archived - a fast CSV command line toolkit written in Rust
* [usql](https://github.com/xo/usql) ⭐ 10,072 | 🐛 119 | 🌐 Go | 📅 2026-06-19 - Universal command-line interface for SQL databases.
* [xxh](https://github.com/xxh/xxh) ⭐ 6,068 | 🐛 30 | 🌐 Python | 📅 2026-06-02 - Bring your favorite shell wherever you go through the SSH.
* [xplr](https://github.com/sayanarijit/xplr) ⭐ 4,803 | 🐛 14 | 🌐 Rust | 📅 2026-08-15 -  A hackable, minimal, fast TUI file explorer
...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 38,677 | 🐛 136 | 🌐 Rust | 📅 2026-08-10 - A faster way to navigate your filesystem, written in Rust
...
* [enhancd](https://github.com/b4b4r07/enhancd) ⭐ 2,710 | 🐛 17 | 🌐 Shell | 📅 2025-01-24 - :rocket: A next-generation cd command with an interactive filter
...
* [powerlevel10k](https://github.com/romkatv/powerlevel10k) ⭐ 54,920 | 🐛 150 | 🌐 Shell | 📅 2026-08-15 - Super flexible awesome powerline ZSH theme
* [Gogh - Color Scheme](https://github.com/Mayccoll/Gogh) ⭐ 10,291 | 🐛 3 | 🌐 Shell | 📅 2026-08-16 - Color Scheme for Gnome Terminal
...
* [just](https://github.com/casey/just) ⭐ 35,313 | 🐛 168 | 🌐 Rust | 📅 2026-08-12 - Task runner for saving and running project-specific commands.
* [dokku](https://github.com/dokku/dokku) ⭐ 32,096 | 🐛 25 | 🌐 Shell | 📅 2026-08-13 - Docker powered mini-Heroku. The smallest PaaS implementation you've ever seen.
* [cloc](https://github.com/AlDanial/cloc) ⭐ 23,438 | 🐛 26 | 🌐 Perl | 📅 2026-08-08 - Count Lines of Code
* [hub](https://github.com/github/hub) ⭐ 22,957 | 🐛 294 | 🌐 Go | 📅 2024-02-02 - hub helps you win at git.
...
* [git-quick-stats](https://github.com/arzzen/git-quick-stats) ⭐ 6,996 | 🐛 3 | 🌐 Shell | 📅 2026-04-18 - Git quick statistics is a simple and efficient way to access various statistics in git repository.
...
* [forgit](https://github.com/wfxr/forgit) ⭐ 5,061 | 🐛 13 | 🌐 Shell | 📅 2026-08-01 - Utility tool for `git` taking advantage of fuzzy finder fzf.
...
* [git-extra-commands](https://github.com/unixorn/git-extra-commands) ⭐ 1,171 | 🐛 2 | 🌐 Shell | 📅 2026-08-10 - Many Git extra utilities. Churn, cut-branch, improved-merge and many more.
...
* [bitwise](https://github.com/mellowcandle/bitwise) ⭐ 721 | 🐛 13 | 🌐 C | 📅 2026-05-17 - Terminal based interactive bit manipulator in curses.
* [nve](https://github.com/ehmicky/nve) ⭐ 712 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-04 - Run any command on specific Node.js versions.
* [bcal](https://github.com/jarun/bcal) ⭐ 698 | 🐛 0 | 🌐 C | 📅 2026-08-16 - Byte CALculator for storage conversions and calculations
...
* [bat](https://github.com/sharkdp/bat) ⭐ 60,192 | 🐛 420 | 🌐 Rust | 📅 2026-08-11 - A `cat` clone with wings
* [btop](https://github.com/aristocratos/btop) ⭐ 34,009 | 🐛 527 | 🌐 C++ | 📅 2026-08-08 - Linux/OSX/FreeBSD resource monitor
...
* [goaccess](https://github.com/allinurl/goaccess) ⭐ 20,825 | 🐛 455 | 🌐 C | 📅 2026-08-05 - GoAccess is a real-time web log analyzer and interactive viewer that runs in a terminal in \*nix systems.
* [lsd](https://github.com/Peltoche/lsd) ⭐ 16,172 | 🐛 206 | 🌐 Rust | 📅 2026-08-16 - LSDeluxe, rewrite of GNU ls with lot of added features like colors, icons, tree-view and more formatting options.
...
* [mtr](https://github.com/traviscross/mtr) ⭐ 3,336 | 🐛 137 | 🌐 C | 📅 2026-06-16 - The functionality of the 'traceroute' and 'ping' programs in a single network diagnostic tool.
...
* [maza](https://github.com/tanrax/maza-ad-blocking) ⭐ 1,868 | 🐛 2 | 🌐 Shell | 📅 2026-08-14 - Local ad blocker. Like Pi-hole but local and using your operating system.
...
* [powertop](https://github.com/fenrus75/powertop) ⭐ 1,328 | 🐛 101 | 🌐 C++ | 📅 2026-08-11 - Battery/Power usage and device stats monitoring command-line tool, with tune-up options.
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 184,833 | 🐛 2,604 | 🌐 Python | 📅 2026-08-16 - Command-line program to download videos from YouTube.com and other video sites
* [aria2](https://github.com/aria2/aria2) ⭐ 41,727 | 🐛 1,159 | 🌐 C++ | 📅 2026-06-25 - aria2 is a lightweight multi-protocol & multi-source, cross platform download utility operated in command-line. It supports HTTP/HTTPS, FTP, BitTorrent and Metalink
* [httpie](https://github.com/httpie/httpie) ⭐ 38,423 | 🐛 330 | 🌐 Python | 📅 2024-12-17 - HTTPie is a command line HTTP client, a user-friendly cURL replacement
...
* [jq](https://github.com/stedolan/jq) ⭐ 35,458 | 🐛 473 | 🌐 C | 📅 2026-08-12 - Sed for json data. You can use it to slice and filter and map and transform structured data
* [fx](https://github.com/antonmedv/fx) ⭐ 20,579 | 🐛 24 | 🌐 Go | 📅 2026-07-28 - Command-line JSON processing tool by anononymus JavaScript functions
* [yq](https://github.com/mikefarah/yq) ⭐ 15,838 | 🐛 287 | 🌐 Go | 📅 2026-08-06 - yq is a portable command-line YAML processor
* [Beets](https://github.com/beetbox/beets) ⭐ 15,545 | 🐛 708 | 🌐 Python | 📅 2026-08-16 - Music library manager and MusicBrainz tagger
* [visidata](https://github.com/saulpw/visidata) ⭐ 9,242 | 🐛 74 | 🌐 Python | 📅 2026-08-15 - A terminal spreadsheet multitool for exploring and arranging data (csv/json/xml/xls/yaml/etc)
* [jc](https://github.com/kellyjonbrazil/jc) ⭐ 8,663 | 🐛 59 | 🌐 Python | 📅 2026-06-18 - Convert command output, file-types, and common strings to JSON or YAML for easier use in scripts.
...
* [cmus](https://github.com/cmus/cmus) ⭐ 6,209 | 🐛 217 | 🌐 C | 📅 2026-08-12 - Cross-platform cli audio player.
...
* [sejda](https://github.com/torakiki/sejda/) ⭐ 546 | 🐛 49 | 🌐 Java | 📅 2026-08-16 - Command line manipulation of PDF documents (split, merge, rotate, convert to jpg, extract text, etc)
* [library](https://github.com/chapmanjacobd/library) ⭐ 480 | 🐛 7 | 🌐 Python | 📅 2026-08-16 - Create SQLITE databases for folders of music, video, images, or online media. Play and track media like Plex but a CLI-only interface with many sorting options.
...
* [wttr.in](https://github.com/chubin/wttr.in) ⭐ 30,350 | 🐛 329 | 🌐 Go | 📅 2026-08-02 - :partly\_sunny: The right way to check the weather (curl wttr.in)
...
* [kanban.bash](https://github.com/coderofsalvation/kanban.bash) ⭐ 954 | 🐛 6 | 🌐 Shell | 📅 2026-07-15 - commandline asciii kanban board for minimalist productivity bash hackers (csv-based)
...
* [homeshick](https://github.com/andsens/homeshick) ⭐ 2,192 | 🐛 17 | 🌐 Shell | 📅 2026-07-10 - Git dotfile synchronizer written in Bash
...
* [shellcheck](https://github.com/koalaman/shellcheck) ⭐ 39,882 | 🐛 1,136 | 🌐 Haskell | 📅 2026-08-04 - Static analysis tool for shell scripts
* [shfmt](https://github.com/mvdan/sh) ⭐ 8,984 | 🐛 97 | 🌐 Go | 📅 2026-08-13 - A shell parser, formatter, and interpreter with bash support; includes shfmt
* [bats](https://github.com/bats-core/bats-core) ⭐ 6,218 | 🐛 124 | 🌐 Shell | 📅 2026-07-26 - Bash Automated Testing System
* [bash-language-server](https://github.com/bash-lsp/bash-language-server) ⭐ 2,768 | 🐛 134 | 🌐 TypeScript | 📅 2026-08-16 - [LSP](https://microsoft.github.io/language-server-protocol/)-based Bash language server
...
* [getoptions](https://github.com/ko1nksm/getoptions) ⭐ 518 | 🐛 16 | 🌐 Shell | 📅 2024-11-18 - An elegant option parser for shell scripts (sh, bash and all POSIX shells)
...
* [The Art of Command Line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,120 | 🐛 256 | 📅 2024-06-25
...
Other amazingly awesome lists can be found in [awesome-awesome](https://github.com/emijrp/awesome-awesome) ⭐ 3,198 | 🐛 25 | 📅 2024-07-31 and [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,610 | 🐛 60 | 🌐 Ruby | 📅 2024-06-02.

### See also

* [awesome-cli-apps](https://github.com/agarrharr/awesome-cli-apps) ⭐ 20,163 | 🐛 0 | 🌐 Shell | 📅 2026-08-04
* [terminals-are-sexy](https://github.com/k4m4/terminals-are-sexy) ⭐ 13,077 | 🐛 147 | 🌐 Shell | 📅 2024-07-26
