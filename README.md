...
* [nushell](https://github.com/nushell/nushell) ⭐ 40,319 | 🐛 1,429 | 🌐 Rust | 📅 2026-08-23 - A modern shell written in Rust
* [murex](https://github.com/lmorg/murex) ⭐ 1,908 | 🐛 85 | 🌐 Go | 📅 2026-07-29 - A smarter shell and scripting environment with advanced features designed for usability, safety and productivity (eg smarter DevOps tooling)
...
* [ngs](https://github.com/ngs-lang/ngs) ⭐ 1,521 | 🐛 303 | 🌐 C | 📅 2026-08-15 - Fully featured scripting language created specifically for Ops. REPL is being developed.
* [ksh93](https://github.com/att/ast) ⚠️ Archived - Korn Shell
* [yash](https://github.com/magicant/yash) ⭐ 560 | 🐛 44 | 🌐 Shell | 📅 2026-08-22 - A POSIX-compliant command line shell with built-in support for completion and prediction based on command history
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 82,619 | 🐛 327 | 🌐 Go | 📅 2026-08-23 - A command-line fuzzy finder
* [rg](https://github.com/BurntSushi/ripgrep) ⭐ 67,523 | 🐛 180 | 🌐 Rust | 📅 2026-08-04 - ripgrep is a line oriented search tool that combines the usability of The Silver Searcher with the raw speed of GNU grep
...
* [nnn](https://github.com/jarun/nnn) ⭐ 21,823 | 🐛 5 | 🌐 C | 📅 2026-08-17 - File browser and disk usage analyzer with excellent desktop integration
* [browsh](https://github.com/browsh-org/browsh) ⭐ 18,999 | 🐛 241 | 🌐 JavaScript | 📅 2025-07-11 - The modern text-based browser
* [navi](https://github.com/denisidoro/navi) ⭐ 17,470 | 🐛 113 | 🌐 Rust | 📅 2026-07-28 - An interactive cheatsheet tool for the command-line
* [direnv](https://github.com/direnv/direnv) ⭐ 15,391 | 🐛 462 | 🌐 Go | 📅 2026-03-31 - An environment switcher for the shell, compare with autoenv
* [mackup](https://github.com/lra/mackup/) ⭐ 15,312 | 🐛 294 | 🌐 Python | 📅 2026-06-15 - Keep your application settings in sync (OS X/Linux)
* [broot](https://github.com/Canop/broot) ⭐ 12,905 | 🐛 231 | 🌐 Rust | 📅 2026-08-23 - A better way to navigate directories
* [lf](https://github.com/gokcehan/lf) ⭐ 9,474 | 🐛 82 | 🌐 Go | 📅 2026-08-15 - Terminal file manager written in Go, inspired by ranger
* [mcfly](https://github.com/cantino/mcfly) ⭐ 7,779 | 🐛 135 | 🌐 Rust | 📅 2026-04-14 - Fly through your shell history. Great Scot!
* [Buku](https://github.com/jarun/Buku) ⭐ 7,181 | 🐛 6 | 🌐 Python | 📅 2026-08-16 - Powerful command-line bookmark manager
...
* [dnote](https://github.com/dnote/dnote) ⭐ 3,065 | 🐛 40 | 🌐 Go | 📅 2026-07-25 - A simple command line notebook with multi-device sync and web interface
...
* [thefuck](https://github.com/nvbn/thefuck) ⭐ 97,735 | 🐛 455 | 🌐 Python | 📅 2024-07-19 - Fix common shell mistakes by using an easy to remember command
* [xsv](https://github.com/BurntSushi/xsv) ⚠️ Archived - a fast CSV command line toolkit written in Rust
* [usql](https://github.com/xo/usql) ⭐ 10,086 | 🐛 118 | 🌐 Go | 📅 2026-06-19 - Universal command-line interface for SQL databases.
* [xxh](https://github.com/xxh/xxh) ⭐ 6,073 | 🐛 30 | 🌐 Python | 📅 2026-06-02 - Bring your favorite shell wherever you go through the SSH.
...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 38,790 | 🐛 137 | 🌐 Rust | 📅 2026-08-22 - A faster way to navigate your filesystem, written in Rust
* [z](https://github.com/rupa/z) ⭐ 17,044 | 🐛 107 | 🌐 Shell | 📅 2024-06-19 - z is the new j, yo
...
* [powerlevel10k](https://github.com/romkatv/powerlevel10k) ⭐ 54,959 | 🐛 150 | 🌐 Shell | 📅 2026-08-15 - Super flexible awesome powerline ZSH theme
* [Gogh - Color Scheme](https://github.com/Mayccoll/Gogh) ⭐ 10,295 | 🐛 3 | 🌐 Shell | 📅 2026-08-16 - Color Scheme for Gnome Terminal
...
* [liquidprompt](https://github.com/nojhan/liquidprompt) ⭐ 4,673 | 🐛 29 | 🌐 Shell | 📅 2026-08-23 - A full-featured & carefully designed adaptive prompt for Bash & Zsh
...
* [just](https://github.com/casey/just) ⭐ 35,434 | 🐛 170 | 🌐 Rust | 📅 2026-08-20 - Task runner for saving and running project-specific commands.
...
* [git-extras](https://github.com/tj/git-extras) ⭐ 18,095 | 🐛 98 | 🌐 Shell | 📅 2026-08-17 - Git utilities -- repo summary, repl, changelog population, author commit percentages and more
...
* [forgit](https://github.com/wfxr/forgit) ⭐ 5,069 | 🐛 14 | 🌐 Shell | 📅 2026-08-21 - Utility tool for `git` taking advantage of fuzzy finder fzf.
...
* [git-open](https://github.com/paulirish/git-open) ⭐ 3,457 | 🐛 49 | 🌐 Shell | 📅 2026-05-25 - Type `git open` to open the GitHub page or website for a repository in your browser
* [gita](https://github.com/nosarthur/gita) ⭐ 1,925 | 🐛 36 | 🌐 Python | 📅 2026-07-06 - A command-line tool to manage multiple git repos.
* [git-extra-commands](https://github.com/unixorn/git-extra-commands) ⭐ 1,169 | 🐛 3 | 🌐 Shell | 📅 2026-08-23 - Many Git extra utilities. Churn, cut-branch, improved-merge and many more.
...
* [bat](https://github.com/sharkdp/bat) ⭐ 60,238 | 🐛 423 | 🌐 Rust | 📅 2026-08-11 - A `cat` clone with wings
* [btop](https://github.com/aristocratos/btop) ⭐ 34,162 | 🐛 528 | 🌐 C++ | 📅 2026-08-23 - Linux/OSX/FreeBSD resource monitor
* [glances](https://github.com/nicolargo/glances) ⭐ 33,411 | 🐛 102 | 🌐 Python | 📅 2026-08-23 - Glances an Eye on your system
* [exa](https://github.com/ogham/exa) ⭐ 24,439 | 🐛 213 | 🌐 Rust | 📅 2024-09-24 - A modern version of `ls`.
* [goaccess](https://github.com/allinurl/goaccess) ⭐ 20,833 | 🐛 457 | 🌐 C | 📅 2026-08-20 - GoAccess is a real-time web log analyzer and interactive viewer that runs in a terminal in \*nix systems.
* [lsd](https://github.com/Peltoche/lsd) ⭐ 16,189 | 🐛 206 | 🌐 Rust | 📅 2026-08-17 - LSDeluxe, rewrite of GNU ls with lot of added features like colors, icons, tree-view and more formatting options.
...
* [bmon](https://github.com/tgraf/bmon) ⭐ 1,382 | 🐛 38 | 🌐 C | 📅 2026-08-03 - Real-time network bandwidth monitor and rate estimator with human-friendly visual output
* [powertop](https://github.com/fenrus75/powertop) ⭐ 1,332 | 🐛 102 | 🌐 C++ | 📅 2026-08-18 - Battery/Power usage and device stats monitoring command-line tool, with tune-up options.
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 186,455 | 🐛 2,605 | 🌐 Python | 📅 2026-08-20 - Command-line program to download videos from YouTube.com and other video sites
* [aria2](https://github.com/aria2/aria2) ⭐ 41,794 | 🐛 1,160 | 🌐 C++ | 📅 2026-06-25 - aria2 is a lightweight multi-protocol & multi-source, cross platform download utility operated in command-line. It supports HTTP/HTTPS, FTP, BitTorrent and Metalink
* [httpie](https://github.com/httpie/httpie) ⭐ 38,447 | 🐛 332 | 🌐 Python | 📅 2024-12-17 - HTTPie is a command line HTTP client, a user-friendly cURL replacement
* [xh](https://github.com/ducaale/xh) ⭐ 8,035 | 🐛 38 | 🌐 Rust | 📅 2026-08-23 - Friendly and fast tool for sending HTTP requests
...
* [shell2http](https://github.com/msoap/shell2http) ⭐ 1,503 | 🐛 6 | 🌐 Go | 📅 2026-08-08 - HTTP-server to execute shell commands. Designed for development, prototyping or remote control
...
* [jq](https://github.com/stedolan/jq) ⭐ 35,475 | 🐛 466 | 🌐 C | 📅 2026-08-23 - Sed for json data. You can use it to slice and filter and map and transform structured data
...
* [yq](https://github.com/mikefarah/yq) ⭐ 15,869 | 🐛 285 | 🌐 Go | 📅 2026-08-20 - yq is a portable command-line YAML processor
* [Beets](https://github.com/beetbox/beets) ⭐ 15,574 | 🐛 711 | 🌐 Python | 📅 2026-08-23 - Music library manager and MusicBrainz tagger
* [visidata](https://github.com/saulpw/visidata) ⭐ 9,250 | 🐛 77 | 🌐 Python | 📅 2026-08-23 - A terminal spreadsheet multitool for exploring and arranging data (csv/json/xml/xls/yaml/etc)
...
* [sejda](https://github.com/torakiki/sejda/) ⭐ 546 | 🐛 49 | 🌐 Java | 📅 2026-08-23 - Command line manipulation of PDF documents (split, merge, rotate, convert to jpg, extract text, etc)
* [library](https://github.com/chapmanjacobd/library) ⭐ 480 | 🐛 7 | 🌐 Python | 📅 2026-08-22 - Create SQLITE databases for folders of music, video, images, or online media. Play and track media like Plex but a CLI-only interface with many sorting options.
...
* [wttr.in](https://github.com/chubin/wttr.in) ⭐ 30,394 | 🐛 330 | 🌐 Go | 📅 2026-08-02 - :partly\_sunny: The right way to check the weather (curl wttr.in)
...
* [jrnl](https://github.com/jrnl-org/jrnl) ⭐ 7,295 | 🐛 150 | 🌐 Python | 📅 2026-08-20 - A simple command line journal application that stores your journal in a plain text file
...
* [ledger](https://github.com/ledger/ledger) ⭐ 6,015 | 🐛 14 | 🌐 C++ | 📅 2026-08-22 - Command line accounting
...
* [fanyi](https://github.com/afc163/fanyi) ⭐ 1,550 | 🐛 4 | 🌐 JavaScript | 📅 2026-08-10 - Translate English to Chinese in terminal
...
* [shellcheck](https://github.com/koalaman/shellcheck) ⭐ 39,913 | 🐛 1,139 | 🌐 Haskell | 📅 2026-08-04 - Static analysis tool for shell scripts
* [shfmt](https://github.com/mvdan/sh) ⭐ 8,999 | 🐛 94 | 🌐 Go | 📅 2026-08-23 - A shell parser, formatter, and interpreter with bash support; includes shfmt
* [bats](https://github.com/bats-core/bats-core) ⭐ 6,226 | 🐛 129 | 🌐 Shell | 📅 2026-07-26 - Bash Automated Testing System
* [bash-language-server](https://github.com/bash-lsp/bash-language-server) ⭐ 2,770 | 🐛 135 | 🌐 TypeScript | 📅 2026-08-23 - [LSP](https://microsoft.github.io/language-server-protocol/)-based Bash language server
...
* [ansi](https://github.com/fidian/ansi) ⭐ 837 | 🐛 2 | 🌐 Shell | 📅 2021-11-28 - ANSI escape codes in pure bash - change text color, position the cursor, much more
...
* [bashew](https://github.com/pforret/bashew) ⭐ 296 | 🐛 2 | 🌐 Shell | 📅 2026-08-20 - bash script creator - from small stand-alone script to complex projects with CI/CD and testing
...
* [The Art of Command Line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,161 | 🐛 257 | 📅 2024-06-25
...
Other amazingly awesome lists can be found in [awesome-awesome](https://github.com/emijrp/awesome-awesome) ⭐ 3,201 | 🐛 25 | 📅 2024-07-31 and [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,618 | 🐛 61 | 🌐 Ruby | 📅 2024-06-02.

### See also

* [awesome-cli-apps](https://github.com/agarrharr/awesome-cli-apps) ⭐ 20,229 | 🐛 0 | 🌐 Shell | 📅 2026-08-22
* [terminals-are-sexy](https://github.com/k4m4/terminals-are-sexy) ⭐ 13,084 | 🐛 148 | 🌐 Shell | 📅 2024-07-26
