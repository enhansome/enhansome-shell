...
* [nushell](https://github.com/nushell/nushell) ⭐ 40,464 | 🐛 1,446 | 🌐 Rust | 📅 2026-09-09 - A modern shell written in Rust
...
* [yash](https://github.com/magicant/yash) ⭐ 568 | 🐛 47 | 🌐 Shell | 📅 2026-09-09 - A POSIX-compliant command line shell with built-in support for completion and prediction based on command history
...
* [rg](https://github.com/BurntSushi/ripgrep) ⭐ 68,130 | 🐛 191 | 🌐 Rust | 📅 2026-08-04 - ripgrep is a line oriented search tool that combines the usability of The Silver Searcher with the raw speed of GNU grep
* [fd](https://github.com/sharkdp/fd) ⭐ 44,349 | 🐛 202 | 🌐 Rust | 📅 2026-09-09 - A simple, fast and user-friendly alternative to find.
* [ag](https://github.com/ggreer/the_silver_searcher) ⭐ 27,119 | 🐛 564 | 🌐 C | 📅 2024-06-16 - Super fast string search through a directory hierarchy
* [nnn](https://github.com/jarun/nnn) ⭐ 21,880 | 🐛 4 | 🌐 C | 📅 2026-09-09 - File browser and disk usage analyzer with excellent desktop integration
...
* [direnv](https://github.com/direnv/direnv) ⭐ 15,432 | 🐛 467 | 🌐 Go | 📅 2026-03-31 - An environment switcher for the shell, compare with autoenv
* [mackup](https://github.com/lra/mackup/) ⭐ 15,320 | 🐛 294 | 🌐 Python | 📅 2026-09-09 - Keep your application settings in sync (OS X/Linux)
* [broot](https://github.com/Canop/broot) ⭐ 12,936 | 🐛 103 | 🌐 Rust | 📅 2026-09-08 - A better way to navigate directories
* [lf](https://github.com/gokcehan/lf) ⭐ 9,498 | 🐛 85 | 🌐 Go | 📅 2026-09-09 - Terminal file manager written in Go, inspired by ranger
...
* [hstr](https://github.com/dvorka/hstr) ⭐ 4,455 | 🐛 186 | 🌐 C | 📅 2026-08-28 - Bash History Suggest Box
* [ddgr](https://github.com/jarun/ddgr) ⭐ 3,542 | 🐛 1 | 🌐 Python | 📅 2026-08-16 - DuckDuckGo from the terminal
...
* [k](https://github.com/supercrabtree/k) ⭐ 1,806 | 🐛 39 | 🌐 Shell | 📅 2023-02-04 - k is a Zsh script to make directory listings more readable, adding Git status, fileweight colors and rotting dates
...
* [thefuck](https://github.com/nvbn/thefuck) ⭐ 97,790 | 🐛 457 | 🌐 Python | 📅 2024-07-19 - Fix common shell mistakes by using an easy to remember command
* [xsv](https://github.com/BurntSushi/xsv) ⚠️ Archived - a fast CSV command line toolkit written in Rust
* [usql](https://github.com/xo/usql) ⭐ 10,107 | 🐛 119 | 🌐 Go | 📅 2026-06-19 - Universal command-line interface for SQL databases.
* [xxh](https://github.com/xxh/xxh) ⭐ 6,083 | 🐛 30 | 🌐 Python | 📅 2026-06-02 - Bring your favorite shell wherever you go through the SSH.
...
* [wemux](https://github.com/zolrath/wemux) ⭐ 3,687 | 🐛 37 | 🌐 Shell | 📅 2022-10-03 - Multi-User Tmux Made Easy
...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 39,318 | 🐛 144 | 🌐 Rust | 📅 2026-09-08 - A faster way to navigate your filesystem, written in Rust
* [z](https://github.com/rupa/z) ⭐ 17,043 | 🐛 108 | 🌐 Shell | 📅 2024-06-19 - z is the new j, yo
...
* [powerlevel10k](https://github.com/romkatv/powerlevel10k) ⭐ 55,074 | 🐛 150 | 🌐 Shell | 📅 2026-09-06 - Super flexible awesome powerline ZSH theme
* [Gogh - Color Scheme](https://github.com/Mayccoll/Gogh) ⭐ 10,311 | 🐛 7 | 🌐 Shell | 📅 2026-09-08 - Color Scheme for Gnome Terminal
...
* [liquidprompt](https://github.com/nojhan/liquidprompt) ⭐ 4,675 | 🐛 29 | 🌐 Shell | 📅 2026-09-07 - A full-featured & carefully designed adaptive prompt for Bash & Zsh
...
* [just](https://github.com/casey/just) ⭐ 35,705 | 🐛 171 | 🌐 Rust | 📅 2026-09-01 - Task runner for saving and running project-specific commands.
* [dokku](https://github.com/dokku/dokku) ⭐ 32,125 | 🐛 39 | 🌐 Shell | 📅 2026-09-09 - Docker powered mini-Heroku. The smallest PaaS implementation you've ever seen.
* [cloc](https://github.com/AlDanial/cloc) ⭐ 23,513 | 🐛 27 | 🌐 Perl | 📅 2026-09-08 - Count Lines of Code
* [hub](https://github.com/github/hub) ⭐ 22,953 | 🐛 295 | 🌐 Go | 📅 2024-02-02 - hub helps you win at git.
* [git-extras](https://github.com/tj/git-extras) ⭐ 18,101 | 🐛 96 | 🌐 Shell | 📅 2026-09-01 - Git utilities -- repo summary, repl, changelog population, author commit percentages and more
* [bocker](https://github.com/p8952/bocker) ⭐ 12,677 | 🐛 15 | 🌐 Shell | 📅 2017-12-09 - Docker implemented in 100 lines of bash
* [git-quick-stats](https://github.com/arzzen/git-quick-stats) ⭐ 7,002 | 🐛 3 | 🌐 Shell | 📅 2026-04-18 - Git quick statistics is a simple and efficient way to access various statistics in git repository.
...
* [forgit](https://github.com/wfxr/forgit) ⭐ 5,075 | 🐛 9 | 🌐 Shell | 📅 2026-09-09 - Utility tool for `git` taking advantage of fuzzy finder fzf.
...
* [bcal](https://github.com/jarun/bcal) ⭐ 702 | 🐛 0 | 🌐 C | 📅 2026-09-05 - Byte CALculator for storage conversions and calculations
...
* [bat](https://github.com/sharkdp/bat) ⭐ 60,392 | 🐛 514 | 🌐 Rust | 📅 2026-09-04 - A `cat` clone with wings
* [btop](https://github.com/aristocratos/btop) ⭐ 34,487 | 🐛 533 | 🌐 C++ | 📅 2026-09-09 - Linux/OSX/FreeBSD resource monitor
...
* [goaccess](https://github.com/allinurl/goaccess) ⭐ 20,917 | 🐛 449 | 🌐 C | 📅 2026-09-03 - GoAccess is a real-time web log analyzer and interactive viewer that runs in a terminal in \*nix systems.
* [lsd](https://github.com/Peltoche/lsd) ⭐ 16,215 | 🐛 207 | 🌐 Rust | 📅 2026-08-17 - LSDeluxe, rewrite of GNU ls with lot of added features like colors, icons, tree-view and more formatting options.
...
* [hblock](https://github.com/hectorm/hblock) ⭐ 1,986 | 🐛 24 | 🌐 Shell | 📅 2026-07-01 - Hosts-file based adblocker
...
* [powertop](https://github.com/fenrus75/powertop) ⭐ 1,334 | 🐛 105 | 🌐 C++ | 📅 2026-09-01 - Battery/Power usage and device stats monitoring command-line tool, with tune-up options.
...
* [nmtui](https://github.com/NetworkManager/NetworkManager) ⭐ 507 | 🐛 0 | 🌐 C | 📅 2026-09-09 - Text User Interface for controlling NetworkManager
...
* [wifi-wand](https://github.com/keithrbennett/wifiwand) ⭐ 80 | 🐛 1 | 🌐 Ruby | 📅 2026-09-01 - a Ruby command line application for managing WiFi on MacOS (install by `gem install wifi-wand`)
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 189,983 | 🐛 2,643 | 🌐 Python | 📅 2026-08-30 - Command-line program to download videos from YouTube.com and other video sites
* [aria2](https://github.com/aria2/aria2) ⭐ 41,965 | 🐛 1,177 | 🌐 C++ | 📅 2026-06-25 - aria2 is a lightweight multi-protocol & multi-source, cross platform download utility operated in command-line. It supports HTTP/HTTPS, FTP, BitTorrent and Metalink
* [httpie](https://github.com/httpie/httpie) ⭐ 38,489 | 🐛 337 | 🌐 Python | 📅 2024-12-17 - HTTPie is a command line HTTP client, a user-friendly cURL replacement
* [xh](https://github.com/ducaale/xh) ⭐ 8,064 | 🐛 37 | 🌐 Rust | 📅 2026-09-05 - Friendly and fast tool for sending HTTP requests
...
* [jq](https://github.com/stedolan/jq) ⭐ 35,558 | 🐛 479 | 🌐 C | 📅 2026-09-01 - Sed for json data. You can use it to slice and filter and map and transform structured data
* [fx](https://github.com/antonmedv/fx) ⭐ 20,620 | 🐛 29 | 🌐 Go | 📅 2026-08-26 - Command-line JSON processing tool by anononymus JavaScript functions
* [yq](https://github.com/mikefarah/yq) ⭐ 15,943 | 🐛 298 | 🌐 Go | 📅 2026-09-03 - yq is a portable command-line YAML processor
* [Beets](https://github.com/beetbox/beets) ⭐ 15,642 | 🐛 711 | 🌐 Python | 📅 2026-09-08 - Music library manager and MusicBrainz tagger
* [visidata](https://github.com/saulpw/visidata) ⭐ 9,266 | 🐛 83 | 🌐 Python | 📅 2026-08-28 - A terminal spreadsheet multitool for exploring and arranging data (csv/json/xml/xls/yaml/etc)
* [jc](https://github.com/kellyjonbrazil/jc) ⭐ 8,671 | 🐛 40 | 🌐 Python | 📅 2026-08-28 - Convert command output, file-types, and common strings to JSON or YAML for easier use in scripts.
...
* [library](https://github.com/chapmanjacobd/library) ⭐ 482 | 🐛 7 | 🌐 Python | 📅 2026-08-29 - Create SQLITE databases for folders of music, video, images, or online media. Play and track media like Plex but a CLI-only interface with many sorting options.
...
* [wttr.in](https://github.com/chubin/wttr.in) ⭐ 30,505 | 🐛 331 | 🌐 Go | 📅 2026-09-07 - :partly\_sunny: The right way to check the weather (curl wttr.in)
...
* [jrnl](https://github.com/jrnl-org/jrnl) ⭐ 7,309 | 🐛 152 | 🌐 Python | 📅 2026-09-09 - A simple command line journal application that stores your journal in a plain text file
...
* [ledger](https://github.com/ledger/ledger) ⭐ 6,031 | 🐛 18 | 🌐 C++ | 📅 2026-09-05 - Command line accounting
* [editly](https://github.com/mifi/editly) ⭐ 5,486 | 🐛 80 | 🌐 TypeScript | 📅 2025-05-12 - Command line video editor
...
* [bash-it](https://github.com/Bash-it/bash-it) ⭐ 15,151 | 🐛 7 | 🌐 Shell | 📅 2026-08-30 - A community Bash framework
...
* [dotdrop](https://github.com/deadc0de6/dotdrop) ⭐ 1,944 | 🐛 0 | 🌐 Python | 📅 2026-09-09 - Save your dotfiles once, deploy them everywhere
...
* [shellcheck](https://github.com/koalaman/shellcheck) ⭐ 40,014 | 🐛 1,139 | 🌐 Haskell | 📅 2026-08-04 - Static analysis tool for shell scripts
* [shfmt](https://github.com/mvdan/sh) ⭐ 9,047 | 🐛 93 | 🌐 Go | 📅 2026-09-09 - A shell parser, formatter, and interpreter with bash support; includes shfmt
* [bats](https://github.com/bats-core/bats-core) ⭐ 6,254 | 🐛 125 | 🌐 Shell | 📅 2026-09-05 - Bash Automated Testing System
* [bash-language-server](https://github.com/bash-lsp/bash-language-server) ⭐ 2,776 | 🐛 137 | 🌐 TypeScript | 📅 2026-09-09 - [LSP](https://microsoft.github.io/language-server-protocol/)-based Bash language server
...
* [The Art of Command Line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,325 | 🐛 257 | 📅 2024-06-25
...
Other amazingly awesome lists can be found in [awesome-awesome](https://github.com/emijrp/awesome-awesome) ⭐ 3,207 | 🐛 26 | 📅 2024-07-31 and [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,660 | 🐛 65 | 🌐 Ruby | 📅 2024-06-02.

### See also

* [awesome-cli-apps](https://github.com/agarrharr/awesome-cli-apps) ⭐ 20,352 | 🐛 1 | 🌐 Shell | 📅 2026-09-05
* [terminals-are-sexy](https://github.com/k4m4/terminals-are-sexy) ⭐ 13,113 | 🐛 151 | 🌐 Shell | 📅 2024-07-26
