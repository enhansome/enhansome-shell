...
* [nushell](https://github.com/nushell/nushell) ⭐ 40,314 | 🐛 1,430 | 🌐 Rust | 📅 2026-08-21 - A modern shell written in Rust
...
* [ngs](https://github.com/ngs-lang/ngs) ⭐ 1,522 | 🐛 303 | 🌐 C | 📅 2026-08-15 - Fully featured scripting language created specifically for Ops. REPL is being developed.
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 82,604 | 🐛 330 | 🌐 Go | 📅 2026-08-21 - A command-line fuzzy finder
* [rg](https://github.com/BurntSushi/ripgrep) ⭐ 67,484 | 🐛 179 | 🌐 Rust | 📅 2026-08-04 - ripgrep is a line oriented search tool that combines the usability of The Silver Searcher with the raw speed of GNU grep
* [fd](https://github.com/sharkdp/fd) ⭐ 44,158 | 🐛 189 | 🌐 Rust | 📅 2026-08-11 - A simple, fast and user-friendly alternative to find.
* [ag](https://github.com/ggreer/the_silver_searcher) ⭐ 27,101 | 🐛 564 | 🌐 C | 📅 2024-06-16 - Super fast string search through a directory hierarchy
...
* [direnv](https://github.com/direnv/direnv) ⭐ 15,387 | 🐛 462 | 🌐 Go | 📅 2026-03-31 - An environment switcher for the shell, compare with autoenv
...
* [lf](https://github.com/gokcehan/lf) ⭐ 9,467 | 🐛 80 | 🌐 Go | 📅 2026-08-15 - Terminal file manager written in Go, inspired by ranger
* [mcfly](https://github.com/cantino/mcfly) ⭐ 7,781 | 🐛 135 | 🌐 Rust | 📅 2026-04-14 - Fly through your shell history. Great Scot!
* [Buku](https://github.com/jarun/Buku) ⭐ 7,179 | 🐛 6 | 🌐 Python | 📅 2026-08-16 - Powerful command-line bookmark manager
...
* [ddgr](https://github.com/jarun/ddgr) ⭐ 3,532 | 🐛 1 | 🌐 Python | 📅 2026-08-16 - DuckDuckGo from the terminal
...
* [dnote](https://github.com/dnote/dnote) ⭐ 3,060 | 🐛 40 | 🌐 Go | 📅 2026-07-25 - A simple command line notebook with multi-device sync and web interface
...
* [bashhub](https://github.com/rcaloras/bashhub-client) ⭐ 1,305 | 🐛 26 | 🌐 Python | 📅 2026-04-15 - :cloud: Bash history in the cloud. Indexed and searchable.
...
* [bartib](https://github.com/nikolassv/bartib) ⭐ 843 | 🐛 19 | 🌐 Rust | 📅 2026-03-25 - A simple timetracker for the command line. It saves a log of all tracked activities as a plaintext file and allows you to create flexible reports.
...
* [thefuck](https://github.com/nvbn/thefuck) ⭐ 97,728 | 🐛 455 | 🌐 Python | 📅 2024-07-19 - Fix common shell mistakes by using an easy to remember command
* [xsv](https://github.com/BurntSushi/xsv) ⚠️ Archived - a fast CSV command line toolkit written in Rust
* [usql](https://github.com/xo/usql) ⭐ 10,082 | 🐛 119 | 🌐 Go | 📅 2026-06-19 - Universal command-line interface for SQL databases.
...
* [xiki](https://github.com/trogdoro/xiki) ⭐ 3,755 | 🐛 118 | 🌐 Ruby | 📅 2020-01-03 - Makes the shell console more friendly and powerful
...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 38,761 | 🐛 138 | 🌐 Rust | 📅 2026-08-21 - A faster way to navigate your filesystem, written in Rust
...
* [z.lua](https://github.com/skywind3000/z.lua) ⭐ 3,143 | 🐛 73 | 🌐 Lua | 📅 2026-08-10 - A new cd command that helps you navigate faster by learning your habits
...
* [powerlevel10k](https://github.com/romkatv/powerlevel10k) ⭐ 54,948 | 🐛 150 | 🌐 Shell | 📅 2026-08-15 - Super flexible awesome powerline ZSH theme
* [Gogh - Color Scheme](https://github.com/Mayccoll/Gogh) ⭐ 10,294 | 🐛 3 | 🌐 Shell | 📅 2026-08-16 - Color Scheme for Gnome Terminal
...
* [oh-my-git](https://github.com/arialdomartini/oh-my-git) ⭐ 3,716 | 🐛 56 | 🌐 Shell | 📅 2022-06-30 - An opinionated git prompt for bash and zsh
...
* [synth-shell](https://github.com/andresgongora/synth-shell) ⭐ 1,133 | 🐛 21 | 🌐 Shell | 📅 2026-08-21 - Greeter with a customizable status report and a fancy bash prompt
...
* [just](https://github.com/casey/just) ⭐ 35,407 | 🐛 170 | 🌐 Rust | 📅 2026-08-20 - Task runner for saving and running project-specific commands.
* [dokku](https://github.com/dokku/dokku) ⭐ 32,108 | 🐛 29 | 🌐 Shell | 📅 2026-08-21 - Docker powered mini-Heroku. The smallest PaaS implementation you've ever seen.
* [cloc](https://github.com/AlDanial/cloc) ⭐ 23,455 | 🐛 26 | 🌐 Perl | 📅 2026-08-08 - Count Lines of Code
* [hub](https://github.com/github/hub) ⭐ 22,956 | 🐛 294 | 🌐 Go | 📅 2024-02-02 - hub helps you win at git.
* [git-extras](https://github.com/tj/git-extras) ⭐ 18,094 | 🐛 98 | 🌐 Shell | 📅 2026-08-17 - Git utilities -- repo summary, repl, changelog population, author commit percentages and more
* [bocker](https://github.com/p8952/bocker) ⭐ 12,664 | 🐛 15 | 🌐 Shell | 📅 2017-12-09 - Docker implemented in 100 lines of bash
* [git-quick-stats](https://github.com/arzzen/git-quick-stats) ⭐ 6,998 | 🐛 3 | 🌐 Shell | 📅 2026-04-18 - Git quick statistics is a simple and efficient way to access various statistics in git repository.
...
* [forgit](https://github.com/wfxr/forgit) ⭐ 5,063 | 🐛 14 | 🌐 Shell | 📅 2026-08-21 - Utility tool for `git` taking advantage of fuzzy finder fzf.
...
* [git-open](https://github.com/paulirish/git-open) ⭐ 3,454 | 🐛 49 | 🌐 Shell | 📅 2026-05-25 - Type `git open` to open the GitHub page or website for a repository in your browser
...
* [repren](https://github.com/jlevy/repren) ⭐ 374 | 🐛 14 | 🌐 Python | 📅 2026-06-10 - Command-line search-and-replace and file-renaming swiss army knife
...
* [bat](https://github.com/sharkdp/bat) ⭐ 60,232 | 🐛 423 | 🌐 Rust | 📅 2026-08-11 - A `cat` clone with wings
* [btop](https://github.com/aristocratos/btop) ⭐ 34,132 | 🐛 529 | 🌐 C++ | 📅 2026-08-08 - Linux/OSX/FreeBSD resource monitor
* [glances](https://github.com/nicolargo/glances) ⭐ 33,396 | 🐛 108 | 🌐 Python | 📅 2026-08-18 - Glances an Eye on your system
* [exa](https://github.com/ogham/exa) ⭐ 24,435 | 🐛 213 | 🌐 Rust | 📅 2024-09-24 - A modern version of `ls`.
* [goaccess](https://github.com/allinurl/goaccess) ⭐ 20,829 | 🐛 455 | 🌐 C | 📅 2026-08-20 - GoAccess is a real-time web log analyzer and interactive viewer that runs in a terminal in \*nix systems.
* [lsd](https://github.com/Peltoche/lsd) ⭐ 16,185 | 🐛 206 | 🌐 Rust | 📅 2026-08-17 - LSDeluxe, rewrite of GNU ls with lot of added features like colors, icons, tree-view and more formatting options.
...
* [hblock](https://github.com/hectorm/hblock) ⭐ 1,978 | 🐛 24 | 🌐 Shell | 📅 2026-07-01 - Hosts-file based adblocker
* [maza](https://github.com/tanrax/maza-ad-blocking) ⭐ 1,869 | 🐛 2 | 🌐 Shell | 📅 2026-08-14 - Local ad blocker. Like Pi-hole but local and using your operating system.
* [bmon](https://github.com/tgraf/bmon) ⭐ 1,381 | 🐛 38 | 🌐 C | 📅 2026-08-03 - Real-time network bandwidth monitor and rate estimator with human-friendly visual output
...
* [ls++](https://github.com/trapd00r/ls--) ⭐ 513 | 🐛 14 | 🌐 Perl | 📅 2024-06-08 - Colorized ls on steroids
* [nmtui](https://github.com/NetworkManager/NetworkManager) ⭐ 504 | 🐛 2 | 🌐 C | 📅 2026-08-21 - Text User Interface for controlling NetworkManager
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 186,073 | 🐛 2,599 | 🌐 Python | 📅 2026-08-20 - Command-line program to download videos from YouTube.com and other video sites
* [aria2](https://github.com/aria2/aria2) ⭐ 41,781 | 🐛 1,160 | 🌐 C++ | 📅 2026-06-25 - aria2 is a lightweight multi-protocol & multi-source, cross platform download utility operated in command-line. It supports HTTP/HTTPS, FTP, BitTorrent and Metalink
* [httpie](https://github.com/httpie/httpie) ⭐ 38,438 | 🐛 332 | 🌐 Python | 📅 2024-12-17 - HTTPie is a command line HTTP client, a user-friendly cURL replacement
* [xh](https://github.com/ducaale/xh) ⭐ 8,032 | 🐛 38 | 🌐 Rust | 📅 2026-08-16 - Friendly and fast tool for sending HTTP requests
...
* [shell2http](https://github.com/msoap/shell2http) ⭐ 1,502 | 🐛 6 | 🌐 Go | 📅 2026-08-08 - HTTP-server to execute shell commands. Designed for development, prototyping or remote control
...
* [jq](https://github.com/stedolan/jq) ⭐ 35,476 | 🐛 472 | 🌐 C | 📅 2026-08-12 - Sed for json data. You can use it to slice and filter and map and transform structured data
...
* [yq](https://github.com/mikefarah/yq) ⭐ 15,871 | 🐛 285 | 🌐 Go | 📅 2026-08-20 - yq is a portable command-line YAML processor
* [Beets](https://github.com/beetbox/beets) ⭐ 15,564 | 🐛 710 | 🌐 Python | 📅 2026-08-20 - Music library manager and MusicBrainz tagger
* [visidata](https://github.com/saulpw/visidata) ⭐ 9,249 | 🐛 79 | 🌐 Python | 📅 2026-08-15 - A terminal spreadsheet multitool for exploring and arranging data (csv/json/xml/xls/yaml/etc)
...
* [wttr.in](https://github.com/chubin/wttr.in) ⭐ 30,382 | 🐛 328 | 🌐 Go | 📅 2026-08-02 - :partly\_sunny: The right way to check the weather (curl wttr.in)
...
* [jrnl](https://github.com/jrnl-org/jrnl) ⭐ 7,294 | 🐛 150 | 🌐 Python | 📅 2026-08-20 - A simple command line journal application that stores your journal in a plain text file
* [ticker](https://github.com/achannarasappa/ticker) ⭐ 6,213 | 🐛 35 | 🌐 Go | 📅 2026-06-28 — Terminal stock ticker with live updates and position tracking
...
* [ledger](https://github.com/ledger/ledger) ⭐ 6,013 | 🐛 16 | 🌐 C++ | 📅 2026-08-21 - Command line accounting
* [editly](https://github.com/mifi/editly) ⭐ 5,473 | 🐛 80 | 🌐 TypeScript | 📅 2025-05-12 - Command line video editor
* [SAWS](https://github.com/donnemartin/saws) ⭐ 5,302 | 🐛 39 | 🌐 Python | 📅 2024-04-02 - A Supercharged AWS CLI
* [awless](https://github.com/wallix/awless) ⭐ 4,957 | 🐛 119 | 🌐 Go | 📅 2022-08-02 - A powerful, innovative and small surface CLI to manage AWS.
...
* [gcalcli](https://github.com/insanum/gcalcli) ⭐ 3,755 | 🐛 170 | 🌐 Python | 📅 2025-10-25 - Google Calendar command line interface
...
* [bash-it](https://github.com/Bash-it/bash-it) ⭐ 15,144 | 🐛 5 | 🌐 Shell | 📅 2026-08-09 - A community Bash framework
...
* [dotdrop](https://github.com/deadc0de6/dotdrop) ⭐ 1,942 | 🐛 3 | 🌐 Python | 📅 2026-08-11 - Save your dotfiles once, deploy them everywhere
...
* [shellcheck](https://github.com/koalaman/shellcheck) ⭐ 39,904 | 🐛 1,140 | 🌐 Haskell | 📅 2026-08-04 - Static analysis tool for shell scripts
* [shfmt](https://github.com/mvdan/sh) ⭐ 8,998 | 🐛 99 | 🌐 Go | 📅 2026-08-20 - A shell parser, formatter, and interpreter with bash support; includes shfmt
* [bats](https://github.com/bats-core/bats-core) ⭐ 6,226 | 🐛 129 | 🌐 Shell | 📅 2026-07-26 - Bash Automated Testing System
...
* [ansi](https://github.com/fidian/ansi) ⭐ 835 | 🐛 2 | 🌐 Shell | 📅 2021-11-28 - ANSI escape codes in pure bash - change text color, position the cursor, much more
...
* [The Art of Command Line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,145 | 🐛 257 | 📅 2024-06-25
...
Other amazingly awesome lists can be found in [awesome-awesome](https://github.com/emijrp/awesome-awesome) ⭐ 3,201 | 🐛 25 | 📅 2024-07-31 and [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,614 | 🐛 60 | 🌐 Ruby | 📅 2024-06-02.

### See also

* [awesome-cli-apps](https://github.com/agarrharr/awesome-cli-apps) ⭐ 20,215 | 🐛 1 | 🌐 Shell | 📅 2026-08-19
* [terminals-are-sexy](https://github.com/k4m4/terminals-are-sexy) ⭐ 13,081 | 🐛 148 | 🌐 Shell | 📅 2024-07-26
