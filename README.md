...
* [nushell](https://github.com/nushell/nushell) ⭐ 40,523 | 🐛 1,440 | 🌐 Rust | 📅 2026-09-18 - A modern shell written in Rust
...
* [ngs](https://github.com/ngs-lang/ngs) ⭐ 1,519 | 🐛 303 | 🌐 C | 📅 2026-09-18 - Fully featured scripting language created specifically for Ops. REPL is being developed.
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 83,115 | 🐛 329 | 🌐 Go | 📅 2026-09-14 - A command-line fuzzy finder
* [rg](https://github.com/BurntSushi/ripgrep) ⭐ 68,411 | 🐛 199 | 🌐 Rust | 📅 2026-08-04 - ripgrep is a line oriented search tool that combines the usability of The Silver Searcher with the raw speed of GNU grep
* [fd](https://github.com/sharkdp/fd) ⭐ 44,480 | 🐛 201 | 🌐 Rust | 📅 2026-09-16 - A simple, fast and user-friendly alternative to find.
* [ag](https://github.com/ggreer/the_silver_searcher) ⭐ 27,120 | 🐛 563 | 🌐 C | 📅 2024-06-16 - Super fast string search through a directory hierarchy
* [nnn](https://github.com/jarun/nnn) ⭐ 21,892 | 🐛 1 | 🌐 C | 📅 2026-09-16 - File browser and disk usage analyzer with excellent desktop integration
* [browsh](https://github.com/browsh-org/browsh) ⭐ 19,050 | 🐛 241 | 🌐 JavaScript | 📅 2025-07-11 - The modern text-based browser
* [navi](https://github.com/denisidoro/navi) ⭐ 17,565 | 🐛 112 | 🌐 Rust | 📅 2026-09-15 - An interactive cheatsheet tool for the command-line
* [direnv](https://github.com/direnv/direnv) ⭐ 15,452 | 🐛 468 | 🌐 Go | 📅 2026-03-31 - An environment switcher for the shell, compare with autoenv
...
* [lf](https://github.com/gokcehan/lf) ⭐ 9,516 | 🐛 84 | 🌐 Go | 📅 2026-09-15 - Terminal file manager written in Go, inspired by ranger
...
* [pathpicker](https://github.com/facebook/PathPicker) ⭐ 5,238 | 🐛 26 | 🌐 Python | 📅 2024-09-05 - Accepts inputs like grep, searches, git etc; allows selecting files from the result of the input, which you can then open or provide as argument to a command.
* [fselect](https://github.com/jhspetersson/fselect) ⭐ 4,466 | 🐛 6 | 🌐 Rust | 📅 2026-09-05 - Find files with SQL-like queries.
* [hstr](https://github.com/dvorka/hstr) ⭐ 4,461 | 🐛 186 | 🌐 C | 📅 2026-09-16 - Bash History Suggest Box
* [ddgr](https://github.com/jarun/ddgr) ⭐ 3,556 | 🐛 1 | 🌐 Python | 📅 2026-08-16 - DuckDuckGo from the terminal
...
* [has](https://github.com/kdabir/has) ⭐ 823 | 🐛 14 | 🌐 Shell | 📅 2026-09-11 - `has` helps you check presence of various command line tools and their versions on path
...
* [aliases](https://github.com/sebglazebrook/aliases) ⭐ 625 | 🐛 16 | 🌐 Rust | 📅 2026-09-18 - Contextual, dynamic, organized aliases for bash
...
* [lowcharts](https://github.com/juan-leon/lowcharts) ⭐ 254 | 🐛 10 | 🌐 Rust | 📅 2025-12-22 - Draw low-resolution graphs in terminal
...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 39,562 | 🐛 146 | 🌐 Rust | 📅 2026-09-14 - A faster way to navigate your filesystem, written in Rust
* [z](https://github.com/rupa/z) ⭐ 17,051 | 🐛 109 | 🌐 Shell | 📅 2024-06-19 - z is the new j, yo
...
* [powerlevel10k](https://github.com/romkatv/powerlevel10k) ⭐ 55,119 | 🐛 150 | 🌐 Shell | 📅 2026-09-14 - Super flexible awesome powerline ZSH theme
* [Gogh - Color Scheme](https://github.com/Mayccoll/Gogh) ⭐ 10,315 | 🐛 7 | 🌐 Shell | 📅 2026-09-18 - Color Scheme for Gnome Terminal
...
* [oh-my-git](https://github.com/arialdomartini/oh-my-git) ⭐ 3,714 | 🐛 56 | 🌐 Shell | 📅 2022-06-30 - An opinionated git prompt for bash and zsh
...
* [bash-powerline](https://github.com/riobard/bash-powerline) ⭐ 910 | 🐛 16 | 🌐 Shell | 📅 2023-07-06 - Powerline-style Bash prompt in pure Bash script
...
* [just](https://github.com/casey/just) ⭐ 35,876 | 🐛 171 | 🌐 Rust | 📅 2026-09-01 - Task runner for saving and running project-specific commands.
* [dokku](https://github.com/dokku/dokku) ⭐ 32,145 | 🐛 32 | 🌐 Go | 📅 2026-09-18 - Docker powered mini-Heroku. The smallest PaaS implementation you've ever seen.
* [cloc](https://github.com/AlDanial/cloc) ⭐ 23,544 | 🐛 27 | 🌐 Perl | 📅 2026-09-14 - Count Lines of Code
* [hub](https://github.com/github/hub) ⭐ 22,955 | 🐛 296 | 🌐 Go | 📅 2024-02-02 - hub helps you win at git.
* [git-extras](https://github.com/tj/git-extras) ⭐ 18,105 | 🐛 100 | 🌐 Shell | 📅 2026-09-01 - Git utilities -- repo summary, repl, changelog population, author commit percentages and more
...
* [forgit](https://github.com/wfxr/forgit) ⭐ 5,079 | 🐛 7 | 🌐 Shell | 📅 2026-09-17 - Utility tool for `git` taking advantage of fuzzy finder fzf.
* [rebound](https://github.com/shobrook/rebound) ⭐ 4,112 | 🐛 24 | 🌐 Python | 📅 2022-02-16 - Instantly browse Stack Overflow results in your terminal when you get a compiler error
...
* [bat](https://github.com/sharkdp/bat) ⭐ 60,498 | 🐛 518 | 🌐 Rust | 📅 2026-09-04 - A `cat` clone with wings
* [btop](https://github.com/aristocratos/btop) ⭐ 34,646 | 🐛 542 | 🌐 C++ | 📅 2026-09-18 - Linux/OSX/FreeBSD resource monitor
* [glances](https://github.com/nicolargo/glances) ⭐ 33,608 | 🐛 103 | 🌐 Python | 📅 2026-09-13 - Glances an Eye on your system
* [exa](https://github.com/ogham/exa) ⭐ 24,444 | 🐛 213 | 🌐 Rust | 📅 2024-09-24 - A modern version of `ls`.
* [goaccess](https://github.com/allinurl/goaccess) ⭐ 20,934 | 🐛 449 | 🌐 C | 📅 2026-09-16 - GoAccess is a real-time web log analyzer and interactive viewer that runs in a terminal in \*nix systems.
* [lsd](https://github.com/Peltoche/lsd) ⭐ 16,232 | 🐛 208 | 🌐 Rust | 📅 2026-08-17 - LSDeluxe, rewrite of GNU ls with lot of added features like colors, icons, tree-view and more formatting options.
...
* [mtr](https://github.com/traviscross/mtr) ⭐ 3,344 | 🐛 141 | 🌐 C | 📅 2026-06-16 - The functionality of the 'traceroute' and 'ping' programs in a single network diagnostic tool.
...
* [nmtui](https://github.com/NetworkManager/NetworkManager) ⭐ 506 | 🐛 0 | 🌐 C | 📅 2026-09-17 - Text User Interface for controlling NetworkManager
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 191,955 | 🐛 2,656 | 🌐 Python | 📅 2026-09-16 - Command-line program to download videos from YouTube.com and other video sites
* [aria2](https://github.com/aria2/aria2) ⭐ 42,498 | 🐛 1,179 | 🌐 C++ | 📅 2026-06-25 - aria2 is a lightweight multi-protocol & multi-source, cross platform download utility operated in command-line. It supports HTTP/HTTPS, FTP, BitTorrent and Metalink
* [httpie](https://github.com/httpie/httpie) ⭐ 38,529 | 🐛 338 | 🌐 Python | 📅 2024-12-17 - HTTPie is a command line HTTP client, a user-friendly cURL replacement
...
* [jq](https://github.com/stedolan/jq) ⭐ 35,618 | 🐛 456 | 🌐 C | 📅 2026-09-18 - Sed for json data. You can use it to slice and filter and map and transform structured data
* [fx](https://github.com/antonmedv/fx) ⭐ 20,633 | 🐛 32 | 🌐 Go | 📅 2026-08-26 - Command-line JSON processing tool by anononymus JavaScript functions
* [yq](https://github.com/mikefarah/yq) ⭐ 15,972 | 🐛 300 | 🌐 Go | 📅 2026-09-17 - yq is a portable command-line YAML processor
* [Beets](https://github.com/beetbox/beets) ⭐ 15,675 | 🐛 707 | 🌐 Python | 📅 2026-09-18 - Music library manager and MusicBrainz tagger
* [visidata](https://github.com/saulpw/visidata) ⭐ 9,283 | 🐛 89 | 🌐 Python | 📅 2026-09-17 - A terminal spreadsheet multitool for exploring and arranging data (csv/json/xml/xls/yaml/etc)
* [jc](https://github.com/kellyjonbrazil/jc) ⭐ 8,677 | 🐛 47 | 🌐 Python | 📅 2026-09-17 - Convert command output, file-types, and common strings to JSON or YAML for easier use in scripts.
* [dasel](https://github.com/tomwright/dasel) ⭐ 8,035 | 🐛 25 | 🌐 Go | 📅 2026-08-16 - Query and update data structures using selectors from the command line. Comparable to [jq](https://github.com/stedolan/jq) ⭐ 35,618 | 🐛 456 | 🌐 C | 📅 2026-09-18 / [yq](https://github.com/kislyuk/yq) ⭐ 2,980 | 🐛 23 | 🌐 Python | 📅 2026-07-11 but supports JSON, YAML, TOML and XML with zero runtime dependencies.
* [cmus](https://github.com/cmus/cmus) ⭐ 6,244 | 🐛 219 | 🌐 C | 📅 2026-08-12 - Cross-platform cli audio player.
...
* [wttr.in](https://github.com/chubin/wttr.in) ⭐ 30,562 | 🐛 331 | 🌐 Go | 📅 2026-09-07 - :partly\_sunny: The right way to check the weather (curl wttr.in)
...
* [jrnl](https://github.com/jrnl-org/jrnl) ⭐ 7,322 | 🐛 152 | 🌐 Python | 📅 2026-09-17 - A simple command line journal application that stores your journal in a plain text file
...
* [ledger](https://github.com/ledger/ledger) ⭐ 6,039 | 🐛 19 | 🌐 C++ | 📅 2026-09-05 - Command line accounting
...
* [gcalcli](https://github.com/insanum/gcalcli) ⭐ 3,766 | 🐛 170 | 🌐 Python | 📅 2025-10-25 - Google Calendar command line interface
...
* [bashblog](https://github.com/cfenollosa/bashblog) ⭐ 1,929 | 🐛 35 | 🌐 Shell | 📅 2026-07-09 - A Bash script that handles blog posting
...
* [sedtris](https://github.com/uuner/sedtris) ⭐ 568 | 🐛 5 | 🌐 Shell | 📅 2020-06-06 - Tetris in sed
...
* [bash-it](https://github.com/Bash-it/bash-it) ⭐ 15,164 | 🐛 6 | 🌐 Shell | 📅 2026-09-13 - A community Bash framework
* [vcsh](https://github.com/RichiH/vcsh) ⭐ 2,276 | 🐛 73 | 🌐 Shell | 📅 2025-12-29 - Config manager based on Git
* [homeshick](https://github.com/andsens/homeshick) ⭐ 2,193 | 🐛 17 | 🌐 Shell | 📅 2026-08-28 - Git dotfile synchronizer written in Bash
* [dotdrop](https://github.com/deadc0de6/dotdrop) ⭐ 1,950 | 🐛 1 | 🌐 Python | 📅 2026-09-09 - Save your dotfiles once, deploy them everywhere
...
* [basher](https://github.com/basherpm/basher) ⭐ 1,303 | 🐛 15 | 🌐 Shell | 📅 2025-11-18 - A package manager for shell scripts
...
* [shellcheck](https://github.com/koalaman/shellcheck) ⭐ 40,055 | 🐛 1,136 | 🌐 Haskell | 📅 2026-09-17 - Static analysis tool for shell scripts
...
* [bats](https://github.com/bats-core/bats-core) ⭐ 6,268 | 🐛 129 | 🌐 Shell | 📅 2026-09-16 - Bash Automated Testing System
* [bash-language-server](https://github.com/bash-lsp/bash-language-server) ⭐ 2,780 | 🐛 66 | 🌐 TypeScript | 📅 2026-09-17 - [LSP](https://microsoft.github.io/language-server-protocol/)-based Bash language server
...
* [mo](https://github.com/tests-always-included/mo) ⭐ 608 | 🐛 11 | 🌐 Shell | 📅 2026-01-19 - Mustache templates in pure bash
...
* [The Art of Command Line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,440 | 🐛 256 | 📅 2024-06-25
* [A guide to learn bash](https://github.com/Idnan/bash-guide) ⭐ 12,383 | 🐛 27 | 📅 2024-08-11
...
Other amazingly awesome lists can be found in [awesome-awesome](https://github.com/emijrp/awesome-awesome) ⭐ 3,208 | 🐛 26 | 📅 2024-07-31 and [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,681 | 🐛 65 | 🌐 Ruby | 📅 2024-06-02.

### See also

* [awesome-cli-apps](https://github.com/agarrharr/awesome-cli-apps) ⭐ 20,422 | 🐛 1 | 🌐 Shell | 📅 2026-09-13
* [terminals-are-sexy](https://github.com/k4m4/terminals-are-sexy) ⭐ 13,120 | 🐛 153 | 🌐 Shell | 📅 2024-07-26
