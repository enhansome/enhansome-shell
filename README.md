...
* [nushell](https://github.com/nushell/nushell) ⭐ 40,530 | 🐛 1,438 | 🌐 Rust | 📅 2026-09-19 - A modern shell written in Rust
...
* [ion](https://github.com/redox-os/ion) ⭐ 1,655 | 🐛 60 | 🌐 Rust | 📅 2026-09-19 - A modern system shell that features a simple, yet powerful, syntax. It is written entirely in Rust.
* [ngs](https://github.com/ngs-lang/ngs) ⭐ 1,519 | 🐛 304 | 🌐 C | 📅 2026-09-18 - Fully featured scripting language created specifically for Ops. REPL is being developed.
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 83,138 | 🐛 329 | 🌐 Go | 📅 2026-09-14 - A command-line fuzzy finder
* [rg](https://github.com/BurntSushi/ripgrep) ⭐ 68,443 | 🐛 199 | 🌐 Rust | 📅 2026-08-04 - ripgrep is a line oriented search tool that combines the usability of The Silver Searcher with the raw speed of GNU grep
* [fd](https://github.com/sharkdp/fd) ⭐ 44,488 | 🐛 201 | 🌐 Rust | 📅 2026-09-16 - A simple, fast and user-friendly alternative to find.
* [ag](https://github.com/ggreer/the_silver_searcher) ⭐ 27,122 | 🐛 563 | 🌐 C | 📅 2024-06-16 - Super fast string search through a directory hierarchy
* [nnn](https://github.com/jarun/nnn) ⭐ 21,955 | 🐛 1 | 🌐 C | 📅 2026-09-19 - File browser and disk usage analyzer with excellent desktop integration
* [browsh](https://github.com/browsh-org/browsh) ⭐ 19,050 | 🐛 241 | 🌐 JavaScript | 📅 2025-07-11 - The modern text-based browser
* [navi](https://github.com/denisidoro/navi) ⭐ 17,571 | 🐛 111 | 🌐 Rust | 📅 2026-09-15 - An interactive cheatsheet tool for the command-line
* [direnv](https://github.com/direnv/direnv) ⭐ 15,453 | 🐛 468 | 🌐 Go | 📅 2026-03-31 - An environment switcher for the shell, compare with autoenv
* [mackup](https://github.com/lra/mackup/) ⭐ 15,326 | 🐛 294 | 🌐 Python | 📅 2026-09-09 - Keep your application settings in sync (OS X/Linux)
* [broot](https://github.com/Canop/broot) ⭐ 12,947 | 🐛 101 | 🌐 Rust | 📅 2026-09-13 - A better way to navigate directories
* [lf](https://github.com/gokcehan/lf) ⭐ 9,516 | 🐛 85 | 🌐 Go | 📅 2026-09-15 - Terminal file manager written in Go, inspired by ranger
* [mcfly](https://github.com/cantino/mcfly) ⭐ 7,797 | 🐛 135 | 🌐 Rust | 📅 2026-09-01 - Fly through your shell history. Great Scot!
* [Buku](https://github.com/jarun/Buku) ⭐ 7,203 | 🐛 2 | 🌐 Python | 📅 2026-09-15 - Powerful command-line bookmark manager
...
* [hstr](https://github.com/dvorka/hstr) ⭐ 4,462 | 🐛 186 | 🌐 C | 📅 2026-09-16 - Bash History Suggest Box
* [ddgr](https://github.com/jarun/ddgr) ⭐ 3,557 | 🐛 1 | 🌐 Python | 📅 2026-08-16 - DuckDuckGo from the terminal
...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 39,580 | 🐛 146 | 🌐 Rust | 📅 2026-09-14 - A faster way to navigate your filesystem, written in Rust
...
* [z.lua](https://github.com/skywind3000/z.lua) ⭐ 3,146 | 🐛 75 | 🌐 Lua | 📅 2026-08-10 - A new cd command that helps you navigate faster by learning your habits
...
* [powerlevel10k](https://github.com/romkatv/powerlevel10k) ⭐ 55,123 | 🐛 150 | 🌐 Shell | 📅 2026-09-14 - Super flexible awesome powerline ZSH theme
* [Gogh - Color Scheme](https://github.com/Mayccoll/Gogh) ⭐ 10,316 | 🐛 7 | 🌐 Shell | 📅 2026-09-18 - Color Scheme for Gnome Terminal
...
* [emojify](https://github.com/mrowa44/emojify) ⭐ 1,586 | 🐛 10 | 🌐 Shell | 📅 2024-01-08 Emoji on the command line :scream:
...
* [just](https://github.com/casey/just) ⭐ 35,894 | 🐛 171 | 🌐 Rust | 📅 2026-09-01 - Task runner for saving and running project-specific commands.
* [dokku](https://github.com/dokku/dokku) ⭐ 32,147 | 🐛 32 | 🌐 Go | 📅 2026-09-19 - Docker powered mini-Heroku. The smallest PaaS implementation you've ever seen.
* [cloc](https://github.com/AlDanial/cloc) ⭐ 23,548 | 🐛 28 | 🌐 Perl | 📅 2026-09-14 - Count Lines of Code
...
* [forgit](https://github.com/wfxr/forgit) ⭐ 5,080 | 🐛 7 | 🌐 Shell | 📅 2026-09-17 - Utility tool for `git` taking advantage of fuzzy finder fzf.
...
* [git-extra-commands](https://github.com/unixorn/git-extra-commands) ⭐ 1,172 | 🐛 6 | 🌐 Shell | 📅 2026-09-19 - Many Git extra utilities. Churn, cut-branch, improved-merge and many more.
...
* [bcal](https://github.com/jarun/bcal) ⭐ 701 | 🐛 0 | 🌐 C | 📅 2026-09-17 - Byte CALculator for storage conversions and calculations
...
* [vmn](https://github.com/final-israel/vmn) ⭐ 65 | 🐛 41 | 🌐 Python | 📅 2026-09-19 - git-based automatic versioning and state recovery solution agnostic to language or architecture
...
* [bat](https://github.com/sharkdp/bat) ⭐ 60,502 | 🐛 518 | 🌐 Rust | 📅 2026-09-04 - A `cat` clone with wings
* [btop](https://github.com/aristocratos/btop) ⭐ 34,658 | 🐛 541 | 🌐 C++ | 📅 2026-09-19 - Linux/OSX/FreeBSD resource monitor
* [glances](https://github.com/nicolargo/glances) ⭐ 33,619 | 🐛 101 | 🌐 Python | 📅 2026-09-19 - Glances an Eye on your system
* [exa](https://github.com/ogham/exa) ⭐ 24,443 | 🐛 213 | 🌐 Rust | 📅 2024-09-24 - A modern version of `ls`.
* [goaccess](https://github.com/allinurl/goaccess) ⭐ 20,939 | 🐛 449 | 🌐 C | 📅 2026-09-19 - GoAccess is a real-time web log analyzer and interactive viewer that runs in a terminal in \*nix systems.
* [lsd](https://github.com/Peltoche/lsd) ⭐ 16,234 | 🐛 208 | 🌐 Rust | 📅 2026-08-17 - LSDeluxe, rewrite of GNU ls with lot of added features like colors, icons, tree-view and more formatting options.
* [progress](https://github.com/Xfennec/progress) ⭐ 8,856 | 🐛 66 | 🌐 C | 📅 2024-11-19 - Linux tool to show progress for `cp`, `rm`, `dd`, and more...
...
* [hblock](https://github.com/hectorm/hblock) ⭐ 1,987 | 🐛 25 | 🌐 Shell | 📅 2026-07-01 - Hosts-file based adblocker
...
* [wifi-wand](https://github.com/keithrbennett/wifiwand) ⭐ 80 | 🐛 7 | 🌐 Ruby | 📅 2026-09-19 - a Ruby command line application for managing WiFi on MacOS (install by `gem install wifi-wand`)
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 192,136 | 🐛 2,659 | 🌐 Python | 📅 2026-09-16 - Command-line program to download videos from YouTube.com and other video sites
* [aria2](https://github.com/aria2/aria2) ⭐ 42,536 | 🐛 1,179 | 🌐 C++ | 📅 2026-06-25 - aria2 is a lightweight multi-protocol & multi-source, cross platform download utility operated in command-line. It supports HTTP/HTTPS, FTP, BitTorrent and Metalink
* [httpie](https://github.com/httpie/httpie) ⭐ 38,532 | 🐛 338 | 🌐 Python | 📅 2024-12-17 - HTTPie is a command line HTTP client, a user-friendly cURL replacement
...
* [resty](https://github.com/micha/resty) ⭐ 2,651 | 🐛 17 | 🌐 Shell | 📅 2023-02-17 - Little command line REST client that you can use in pipelines
...
* [jq](https://github.com/stedolan/jq) ⭐ 35,623 | 🐛 451 | 🌐 C | 📅 2026-09-19 - Sed for json data. You can use it to slice and filter and map and transform structured data
* [fx](https://github.com/antonmedv/fx) ⭐ 20,634 | 🐛 32 | 🌐 Go | 📅 2026-08-26 - Command-line JSON processing tool by anononymus JavaScript functions
* [yq](https://github.com/mikefarah/yq) ⭐ 15,979 | 🐛 303 | 🌐 Go | 📅 2026-09-17 - yq is a portable command-line YAML processor
* [Beets](https://github.com/beetbox/beets) ⭐ 15,678 | 🐛 711 | 🌐 Python | 📅 2026-09-19 - Music library manager and MusicBrainz tagger
* [visidata](https://github.com/saulpw/visidata) ⭐ 9,285 | 🐛 89 | 🌐 Python | 📅 2026-09-17 - A terminal spreadsheet multitool for exploring and arranging data (csv/json/xml/xls/yaml/etc)
...
* [wttr.in](https://github.com/chubin/wttr.in) ⭐ 30,566 | 🐛 331 | 🌐 Go | 📅 2026-09-07 - :partly\_sunny: The right way to check the weather (curl wttr.in)
...
* [jrnl](https://github.com/jrnl-org/jrnl) ⭐ 7,321 | 🐛 152 | 🌐 Python | 📅 2026-09-19 - A simple command line journal application that stores your journal in a plain text file
* [ticker](https://github.com/achannarasappa/ticker) ⭐ 6,235 | 🐛 34 | 🌐 Go | 📅 2026-06-28 — Terminal stock ticker with live updates and position tracking
* [ledger](https://github.com/ledger/ledger) ⭐ 6,039 | 🐛 17 | 🌐 C++ | 📅 2026-09-05 - Command line accounting
...
* [editly](https://github.com/mifi/editly) ⭐ 5,505 | 🐛 80 | 🌐 TypeScript | 📅 2025-05-12 - Command line video editor
...
* [bash-it](https://github.com/Bash-it/bash-it) ⭐ 15,165 | 🐛 6 | 🌐 Shell | 📅 2026-09-13 - A community Bash framework
* [vcsh](https://github.com/RichiH/vcsh) ⭐ 2,277 | 🐛 73 | 🌐 Shell | 📅 2025-12-29 - Config manager based on Git
* [homeshick](https://github.com/andsens/homeshick) ⭐ 2,194 | 🐛 17 | 🌐 Shell | 📅 2026-08-28 - Git dotfile synchronizer written in Bash
...
* [shellcheck](https://github.com/koalaman/shellcheck) ⭐ 40,057 | 🐛 1,136 | 🌐 Haskell | 📅 2026-09-17 - Static analysis tool for shell scripts
* [shfmt](https://github.com/mvdan/sh) ⭐ 9,066 | 🐛 93 | 🌐 Go | 📅 2026-09-09 - A shell parser, formatter, and interpreter with bash support; includes shfmt
* [bats](https://github.com/bats-core/bats-core) ⭐ 6,272 | 🐛 129 | 🌐 Shell | 📅 2026-09-16 - Bash Automated Testing System
* [bash-language-server](https://github.com/bash-lsp/bash-language-server) ⭐ 2,780 | 🐛 68 | 🌐 TypeScript | 📅 2026-09-19 - [LSP](https://microsoft.github.io/language-server-protocol/)-based Bash language server
...
* [bashew](https://github.com/pforret/bashew) ⭐ 297 | 🐛 1 | 🌐 Shell | 📅 2026-09-19 - bash script creator - from small stand-alone script to complex projects with CI/CD and testing
...
* [The Art of Command Line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,454 | 🐛 256 | 📅 2024-06-25
...
* [terminals-are-sexy](https://github.com/k4m4/terminals-are-sexy) ⭐ 13,121 | 🐛 155 | 🌐 Shell | 📅 2024-07-26
