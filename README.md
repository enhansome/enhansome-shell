...
* [nushell](https://github.com/nushell/nushell) ⭐ 40,425 | 🐛 1,433 | 🌐 Rust | 📅 2026-09-06 - A modern shell written in Rust
* [murex](https://github.com/lmorg/murex) ⭐ 1,912 | 🐛 85 | 🌐 Go | 📅 2026-08-26 - A smarter shell and scripting environment with advanced features designed for usability, safety and productivity (eg smarter DevOps tooling)
...
* [yash](https://github.com/magicant/yash) ⭐ 565 | 🐛 46 | 🌐 Shell | 📅 2026-09-01 - A POSIX-compliant command line shell with built-in support for completion and prediction based on command history
...
* [rg](https://github.com/BurntSushi/ripgrep) ⭐ 68,008 | 🐛 187 | 🌐 Rust | 📅 2026-08-04 - ripgrep is a line oriented search tool that combines the usability of The Silver Searcher with the raw speed of GNU grep
...
* [nnn](https://github.com/jarun/nnn) ⭐ 21,867 | 🐛 4 | 🌐 C | 📅 2026-09-05 - File browser and disk usage analyzer with excellent desktop integration
* [browsh](https://github.com/browsh-org/browsh) ⭐ 19,029 | 🐛 241 | 🌐 JavaScript | 📅 2025-07-11 - The modern text-based browser
* [navi](https://github.com/denisidoro/navi) ⭐ 17,515 | 🐛 112 | 🌐 Rust | 📅 2026-07-28 - An interactive cheatsheet tool for the command-line
* [direnv](https://github.com/direnv/direnv) ⭐ 15,422 | 🐛 465 | 🌐 Go | 📅 2026-03-31 - An environment switcher for the shell, compare with autoenv
* [mackup](https://github.com/lra/mackup/) ⭐ 15,319 | 🐛 294 | 🌐 Python | 📅 2026-06-15 - Keep your application settings in sync (OS X/Linux)
* [broot](https://github.com/Canop/broot) ⭐ 12,929 | 🐛 102 | 🌐 Rust | 📅 2026-09-06 - A better way to navigate directories
* [lf](https://github.com/gokcehan/lf) ⭐ 9,491 | 🐛 84 | 🌐 Go | 📅 2026-08-25 - Terminal file manager written in Go, inspired by ranger
* [mcfly](https://github.com/cantino/mcfly) ⭐ 7,787 | 🐛 134 | 🌐 Rust | 📅 2026-09-01 - Fly through your shell history. Great Scot!
* [Buku](https://github.com/jarun/Buku) ⭐ 7,192 | 🐛 6 | 🌐 Python | 📅 2026-08-16 - Powerful command-line bookmark manager
* [googler](https://github.com/jarun/googler) ⚠️ Archived - Google Search, Google Site Search, Google News from the terminal
* [spark](https://github.com/holman/spark) ⭐ 6,072 | 🐛 17 | 🌐 Shell | 📅 2022-05-07 - ▁▂▃▅▂▇ in your shell
...
* [how2](https://github.com/santinic/how2) ⭐ 5,769 | 🐛 6 | 🌐 JavaScript | 📅 2023-03-15 - `how2` finds the simplest way to do something in a unix shell. It's like `man`, but you can query it in natural language.
* [pathpicker](https://github.com/facebook/PathPicker) ⭐ 5,225 | 🐛 26 | 🌐 Python | 📅 2024-09-05 - Accepts inputs like grep, searches, git etc; allows selecting files from the result of the input, which you can then open or provide as argument to a command.
* [fselect](https://github.com/jhspetersson/fselect) ⭐ 4,458 | 🐛 6 | 🌐 Rust | 📅 2026-09-05 - Find files with SQL-like queries.
* [hstr](https://github.com/dvorka/hstr) ⭐ 4,455 | 🐛 185 | 🌐 C | 📅 2026-08-28 - Bash History Suggest Box
* [ddgr](https://github.com/jarun/ddgr) ⭐ 3,541 | 🐛 1 | 🌐 Python | 📅 2026-08-16 - DuckDuckGo from the terminal
* [percol](https://github.com/mooz/percol) ⭐ 3,325 | 🐛 51 | 🌐 Python | 📅 2023-12-30 - Adds flavor of interactive filtering to the traditional pipe concept of UNIX shell
...
* [desk](https://github.com/jamesob/desk) ⭐ 2,574 | 🐛 19 | 🌐 Shell | 📅 2022-07-07 - A lightweight workspace manager for the shell
...
* [boilr](https://github.com/tmrts/boilr) ⭐ 1,761 | 🐛 44 | 🌐 Go | 📅 2023-03-07 - A blazingly fast CLI tool for creating projects from boilerplate templates.
* [borg](https://github.com/ok-borg/borg) ⚠️ Archived - A terminal based search engine for bash commands
* [arttime](https://github.com/reportaman/arttime) ⭐ 1,382 | 🐛 6 | 🌐 Shell | 📅 2026-08-18 - Beauty of text art meets functionality of clock, timer, pomodoro++ time manager
...
* [bartib](https://github.com/nikolassv/bartib) ⭐ 846 | 🐛 19 | 🌐 Rust | 📅 2026-03-25 - A simple timetracker for the command line. It saves a log of all tracked activities as a plaintext file and allows you to create flexible reports.
* [has](https://github.com/kdabir/has) ⭐ 819 | 🐛 14 | 🌐 Shell | 📅 2026-09-05 - `has` helps you check presence of various command line tools and their versions on path
...
* [lowcharts](https://github.com/juan-leon/lowcharts) ⭐ 251 | 🐛 10 | 🌐 Rust | 📅 2025-12-22 - Draw low-resolution graphs in terminal
...
* [thefuck](https://github.com/nvbn/thefuck) ⭐ 97,769 | 🐛 456 | 🌐 Python | 📅 2024-07-19 - Fix common shell mistakes by using an easy to remember command
* [xsv](https://github.com/BurntSushi/xsv) ⚠️ Archived - a fast CSV command line toolkit written in Rust
* [usql](https://github.com/xo/usql) ⭐ 10,099 | 🐛 118 | 🌐 Go | 📅 2026-06-19 - Universal command-line interface for SQL databases.
...
* [wemux](https://github.com/zolrath/wemux) ⭐ 3,682 | 🐛 37 | 🌐 Shell | 📅 2022-10-03 - Multi-User Tmux Made Easy
...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 39,195 | 🐛 143 | 🌐 Rust | 📅 2026-08-31 - A faster way to navigate your filesystem, written in Rust
* [z](https://github.com/rupa/z) ⭐ 17,042 | 🐛 108 | 🌐 Shell | 📅 2024-06-19 - z is the new j, yo
...
* [z.lua](https://github.com/skywind3000/z.lua) ⭐ 3,145 | 🐛 74 | 🌐 Lua | 📅 2026-08-10 - A new cd command that helps you navigate faster by learning your habits
* [enhancd](https://github.com/b4b4r07/enhancd) ⭐ 2,716 | 🐛 17 | 🌐 Shell | 📅 2025-01-24 - :rocket: A next-generation cd command with an interactive filter
...
* [powerlevel10k](https://github.com/romkatv/powerlevel10k) ⭐ 55,045 | 🐛 150 | 🌐 Shell | 📅 2026-08-15 - Super flexible awesome powerline ZSH theme
* [Gogh - Color Scheme](https://github.com/Mayccoll/Gogh) ⭐ 10,309 | 🐛 6 | 🌐 Shell | 📅 2026-09-06 - Color Scheme for Gnome Terminal
...
* [just](https://github.com/casey/just) ⭐ 35,663 | 🐛 171 | 🌐 Rust | 📅 2026-09-01 - Task runner for saving and running project-specific commands.
* [dokku](https://github.com/dokku/dokku) ⭐ 32,122 | 🐛 37 | 🌐 Shell | 📅 2026-09-06 - Docker powered mini-Heroku. The smallest PaaS implementation you've ever seen.
* [cloc](https://github.com/AlDanial/cloc) ⭐ 23,505 | 🐛 28 | 🌐 Perl | 📅 2026-09-02 - Count Lines of Code
* [hub](https://github.com/github/hub) ⭐ 22,956 | 🐛 294 | 🌐 Go | 📅 2024-02-02 - hub helps you win at git.
* [git-extras](https://github.com/tj/git-extras) ⭐ 18,102 | 🐛 95 | 🌐 Shell | 📅 2026-09-01 - Git utilities -- repo summary, repl, changelog population, author commit percentages and more
* [bocker](https://github.com/p8952/bocker) ⭐ 12,676 | 🐛 15 | 🌐 Shell | 📅 2017-12-09 - Docker implemented in 100 lines of bash
* [git-quick-stats](https://github.com/arzzen/git-quick-stats) ⭐ 7,004 | 🐛 3 | 🌐 Shell | 📅 2026-04-18 - Git quick statistics is a simple and efficient way to access various statistics in git repository.
...
* [forgit](https://github.com/wfxr/forgit) ⭐ 5,076 | 🐛 10 | 🌐 Shell | 📅 2026-09-05 - Utility tool for `git` taking advantage of fuzzy finder fzf.
...
* [gita](https://github.com/nosarthur/gita) ⭐ 1,935 | 🐛 36 | 🌐 Python | 📅 2026-07-06 - A command-line tool to manage multiple git repos.
* [git-extra-commands](https://github.com/unixorn/git-extra-commands) ⭐ 1,170 | 🐛 2 | 🌐 Shell | 📅 2026-09-04 - Many Git extra utilities. Churn, cut-branch, improved-merge and many more.
...
* [bcal](https://github.com/jarun/bcal) ⭐ 701 | 🐛 0 | 🌐 C | 📅 2026-09-05 - Byte CALculator for storage conversions and calculations
...
* [bat](https://github.com/sharkdp/bat) ⭐ 60,380 | 🐛 426 | 🌐 Rust | 📅 2026-09-04 - A `cat` clone with wings
* [btop](https://github.com/aristocratos/btop) ⭐ 34,429 | 🐛 531 | 🌐 C++ | 📅 2026-09-05 - Linux/OSX/FreeBSD resource monitor
...
* [goaccess](https://github.com/allinurl/goaccess) ⭐ 20,910 | 🐛 449 | 🌐 C | 📅 2026-09-03 - GoAccess is a real-time web log analyzer and interactive viewer that runs in a terminal in \*nix systems.
* [lsd](https://github.com/Peltoche/lsd) ⭐ 16,216 | 🐛 205 | 🌐 Rust | 📅 2026-08-17 - LSDeluxe, rewrite of GNU ls with lot of added features like colors, icons, tree-view and more formatting options.
...
* [hblock](https://github.com/hectorm/hblock) ⭐ 1,984 | 🐛 24 | 🌐 Shell | 📅 2026-07-01 - Hosts-file based adblocker
...
* [bmon](https://github.com/tgraf/bmon) ⭐ 1,387 | 🐛 38 | 🌐 C | 📅 2026-08-24 - Real-time network bandwidth monitor and rate estimator with human-friendly visual output
* [powertop](https://github.com/fenrus75/powertop) ⭐ 1,335 | 🐛 105 | 🌐 C++ | 📅 2026-09-01 - Battery/Power usage and device stats monitoring command-line tool, with tune-up options.
...
* [nmtui](https://github.com/NetworkManager/NetworkManager) ⭐ 506 | 🐛 2 | 🌐 C | 📅 2026-09-04 - Text User Interface for controlling NetworkManager
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 189,401 | 🐛 2,639 | 🌐 Python | 📅 2026-08-30 - Command-line program to download videos from YouTube.com and other video sites
* [aria2](https://github.com/aria2/aria2) ⭐ 41,933 | 🐛 1,176 | 🌐 C++ | 📅 2026-06-25 - aria2 is a lightweight multi-protocol & multi-source, cross platform download utility operated in command-line. It supports HTTP/HTTPS, FTP, BitTorrent and Metalink
* [httpie](https://github.com/httpie/httpie) ⭐ 38,486 | 🐛 337 | 🌐 Python | 📅 2024-12-17 - HTTPie is a command line HTTP client, a user-friendly cURL replacement
* [xh](https://github.com/ducaale/xh) ⭐ 8,060 | 🐛 37 | 🌐 Rust | 📅 2026-09-05 - Friendly and fast tool for sending HTTP requests
...
* [jq](https://github.com/stedolan/jq) ⭐ 35,558 | 🐛 478 | 🌐 C | 📅 2026-09-01 - Sed for json data. You can use it to slice and filter and map and transform structured data
* [fx](https://github.com/antonmedv/fx) ⭐ 20,619 | 🐛 27 | 🌐 Go | 📅 2026-08-26 - Command-line JSON processing tool by anononymus JavaScript functions
* [yq](https://github.com/mikefarah/yq) ⭐ 15,928 | 🐛 299 | 🌐 Go | 📅 2026-09-03 - yq is a portable command-line YAML processor
* [Beets](https://github.com/beetbox/beets) ⭐ 15,626 | 🐛 712 | 🌐 Python | 📅 2026-09-06 - Music library manager and MusicBrainz tagger
* [visidata](https://github.com/saulpw/visidata) ⭐ 9,262 | 🐛 82 | 🌐 Python | 📅 2026-08-28 - A terminal spreadsheet multitool for exploring and arranging data (csv/json/xml/xls/yaml/etc)
...
* [wttr.in](https://github.com/chubin/wttr.in) ⭐ 30,492 | 🐛 331 | 🌐 Go | 📅 2026-08-02 - :partly\_sunny: The right way to check the weather (curl wttr.in)
...
* [jrnl](https://github.com/jrnl-org/jrnl) ⭐ 7,310 | 🐛 151 | 🌐 Python | 📅 2026-09-04 - A simple command line journal application that stores your journal in a plain text file
* [ticker](https://github.com/achannarasappa/ticker) ⭐ 6,224 | 🐛 33 | 🌐 Go | 📅 2026-06-28 — Terminal stock ticker with live updates and position tracking
...
* [ledger](https://github.com/ledger/ledger) ⭐ 6,029 | 🐛 18 | 🌐 C++ | 📅 2026-09-05 - Command line accounting
* [editly](https://github.com/mifi/editly) ⭐ 5,485 | 🐛 80 | 🌐 TypeScript | 📅 2025-05-12 - Command line video editor
...
* [fanyi](https://github.com/afc163/fanyi) ⭐ 1,553 | 🐛 4 | 🌐 JavaScript | 📅 2026-08-31 - Translate English to Chinese in terminal
* [dstask](https://github.com/naggie/dstask) ⭐ 1,204 | 🐛 43 | 🌐 Go | 📅 2026-05-11 - Single binary terminal-based TODO manager with git-based sync + markdown notes per task
* [kanban.bash](https://github.com/coderofsalvation/kanban.bash) ⭐ 957 | 🐛 6 | 🌐 Shell | 📅 2026-07-15 - commandline asciii kanban board for minimalist productivity bash hackers (csv-based)
...
* [pcalc](https://github.com/alt-romes/programmer-calculator) ⭐ 590 | 🐛 5 | 🌐 C | 📅 2025-11-06 - Calculator made for programmers working with multiple number representations, sizes, and overall close to the bits.
...
* [dotdrop](https://github.com/deadc0de6/dotdrop) ⭐ 1,943 | 🐛 0 | 🌐 Python | 📅 2026-08-31 - Save your dotfiles once, deploy them everywhere
...
* [shellcheck](https://github.com/koalaman/shellcheck) ⭐ 39,998 | 🐛 1,139 | 🌐 Haskell | 📅 2026-08-04 - Static analysis tool for shell scripts
* [shfmt](https://github.com/mvdan/sh) ⭐ 9,040 | 🐛 93 | 🌐 Go | 📅 2026-09-06 - A shell parser, formatter, and interpreter with bash support; includes shfmt
* [bats](https://github.com/bats-core/bats-core) ⭐ 6,249 | 🐛 125 | 🌐 Shell | 📅 2026-09-05 - Bash Automated Testing System
* [bash-language-server](https://github.com/bash-lsp/bash-language-server) ⭐ 2,777 | 🐛 136 | 🌐 TypeScript | 📅 2026-09-02 - [LSP](https://microsoft.github.io/language-server-protocol/)-based Bash language server
...
* [The Art of Command Line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,273 | 🐛 257 | 📅 2024-06-25
...
Other amazingly awesome lists can be found in [awesome-awesome](https://github.com/emijrp/awesome-awesome) ⭐ 3,207 | 🐛 26 | 📅 2024-07-31 and [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,655 | 🐛 62 | 🌐 Ruby | 📅 2024-06-02.

### See also

* [awesome-cli-apps](https://github.com/agarrharr/awesome-cli-apps) ⭐ 20,337 | 🐛 1 | 🌐 Shell | 📅 2026-09-05
* [terminals-are-sexy](https://github.com/k4m4/terminals-are-sexy) ⭐ 13,112 | 🐛 151 | 🌐 Shell | 📅 2024-07-26
