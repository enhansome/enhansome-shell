...
* [nushell](https://github.com/nushell/nushell) ⭐ 40,551 | 🐛 1,434 | 🌐 Rust | 📅 2026-09-22 - A modern shell written in Rust
...
* [ngs](https://github.com/ngs-lang/ngs) ⭐ 1,519 | 🐛 304 | 🌐 C | 📅 2026-09-21 - Fully featured scripting language created specifically for Ops. REPL is being developed.
...
* [rg](https://github.com/BurntSushi/ripgrep) ⭐ 68,511 | 🐛 200 | 🌐 Rust | 📅 2026-08-04 - ripgrep is a line oriented search tool that combines the usability of The Silver Searcher with the raw speed of GNU grep
...
* [nnn](https://github.com/jarun/nnn) ⭐ 21,993 | 🐛 1 | 🌐 C | 📅 2026-09-21 - File browser and disk usage analyzer with excellent desktop integration
* [browsh](https://github.com/browsh-org/browsh) ⭐ 19,057 | 🐛 241 | 🌐 JavaScript | 📅 2025-07-11 - The modern text-based browser
* [navi](https://github.com/denisidoro/navi) ⭐ 17,610 | 🐛 110 | 🌐 Rust | 📅 2026-09-20 - An interactive cheatsheet tool for the command-line
* [direnv](https://github.com/direnv/direnv) ⭐ 15,454 | 🐛 468 | 🌐 Go | 📅 2026-03-31 - An environment switcher for the shell, compare with autoenv
...
* [lf](https://github.com/gokcehan/lf) ⭐ 9,520 | 🐛 85 | 🌐 Go | 📅 2026-09-15 - Terminal file manager written in Go, inspired by ranger
* [mcfly](https://github.com/cantino/mcfly) ⭐ 7,798 | 🐛 135 | 🌐 Rust | 📅 2026-09-01 - Fly through your shell history. Great Scot!
* [Buku](https://github.com/jarun/Buku) ⭐ 7,206 | 🐛 2 | 🌐 Python | 📅 2026-09-15 - Powerful command-line bookmark manager
...
* [hstr](https://github.com/dvorka/hstr) ⭐ 4,464 | 🐛 186 | 🌐 C | 📅 2026-09-16 - Bash History Suggest Box
...
* [marker](https://github.com/pindexis/marker) ⭐ 2,093 | 🐛 49 | 🌐 Python | 📅 2024-04-06 - Bookmark your shell commands
* [k](https://github.com/supercrabtree/k) ⭐ 1,804 | 🐛 41 | 🌐 Shell | 📅 2023-02-04 - k is a Zsh script to make directory listings more readable, adding Git status, fileweight colors and rotting dates
...
* [eureka](https://github.com/simeg/eureka/) ⭐ 880 | 🐛 6 | 🌐 Rust | 📅 2026-08-28 - :bulb: CLI tool to input and store your ideas without leaving the terminal
...
* [aliases](https://github.com/sebglazebrook/aliases) ⭐ 626 | 🐛 16 | 🌐 Rust | 📅 2026-09-18 - Contextual, dynamic, organized aliases for bash
...
* [await](https://github.com/slavaGanzin/await) ⭐ 277 | 🐛 2 | 🌐 Python | 📅 2026-08-08 - single binary that run list of commands in parallel and waits for their termination
...
* [thefuck](https://github.com/nvbn/thefuck) ⭐ 97,866 | 🐛 461 | 🌐 Python | 📅 2024-07-19 - Fix common shell mistakes by using an easy to remember command
* [xsv](https://github.com/BurntSushi/xsv) ⚠️ Archived - a fast CSV command line toolkit written in Rust
* [usql](https://github.com/xo/usql) ⭐ 10,120 | 🐛 121 | 🌐 Go | 📅 2026-09-22 - Universal command-line interface for SQL databases.
* [xxh](https://github.com/xxh/xxh) ⭐ 6,097 | 🐛 30 | 🌐 Python | 📅 2026-06-02 - Bring your favorite shell wherever you go through the SSH.
* [xplr](https://github.com/sayanarijit/xplr) ⭐ 4,827 | 🐛 12 | 🌐 Rust | 📅 2026-09-22 -  A hackable, minimal, fast TUI file explorer
...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 39,654 | 🐛 147 | 🌐 Rust | 📅 2026-09-21 - A faster way to navigate your filesystem, written in Rust
* [z](https://github.com/rupa/z) ⭐ 17,052 | 🐛 108 | 🌐 Shell | 📅 2024-06-19 - z is the new j, yo
* [autojump](https://github.com/wting/autojump) ⭐ 16,959 | 🐛 232 | 🌐 Python | 📅 2025-02-27 - A cd command that learns - easily navigate directories from the command line
...
* [jump](https://github.com/gsamokovarov/jump) ⭐ 1,945 | 🐛 2 | 🌐 Go | 📅 2026-09-21 - Jump helps you navigate your file system faster by learning your habits.
...
* [powerlevel10k](https://github.com/romkatv/powerlevel10k) ⭐ 55,140 | 🐛 152 | 🌐 Shell | 📅 2026-09-14 - Super flexible awesome powerline ZSH theme
* [Gogh - Color Scheme](https://github.com/Mayccoll/Gogh) ⭐ 10,317 | 🐛 7 | 🌐 Shell | 📅 2026-09-22 - Color Scheme for Gnome Terminal
...
* [aphrodite-terminal-theme](https://github.com/win0err/aphrodite-terminal-theme) ⭐ 174 | 🐛 2 | 🌐 Shell | 📅 2025-08-04 — Minimalistic Aphrodite theme (prompt) for sexy terminals that works in bash, fish and zsh
...
* [just](https://github.com/casey/just) ⭐ 35,958 | 🐛 171 | 🌐 Rust | 📅 2026-09-22 - Task runner for saving and running project-specific commands.
* [dokku](https://github.com/dokku/dokku) ⭐ 32,151 | 🐛 28 | 🌐 Go | 📅 2026-09-22 - Docker powered mini-Heroku. The smallest PaaS implementation you've ever seen.
* [cloc](https://github.com/AlDanial/cloc) ⭐ 23,554 | 🐛 26 | 🌐 Perl | 📅 2026-09-20 - Count Lines of Code
* [hub](https://github.com/github/hub) ⭐ 22,954 | 🐛 296 | 🌐 Go | 📅 2024-02-02 - hub helps you win at git.
* [git-extras](https://github.com/tj/git-extras) ⭐ 18,108 | 🐛 93 | 🌐 Shell | 📅 2026-09-21 - Git utilities -- repo summary, repl, changelog population, author commit percentages and more
...
* [forgit](https://github.com/wfxr/forgit) ⭐ 5,083 | 🐛 7 | 🌐 Shell | 📅 2026-09-17 - Utility tool for `git` taking advantage of fuzzy finder fzf.
...
* [git-extra-commands](https://github.com/unixorn/git-extra-commands) ⭐ 1,171 | 🐛 4 | 🌐 Shell | 📅 2026-09-21 - Many Git extra utilities. Churn, cut-branch, improved-merge and many more.
* [git-sh](https://github.com/rtomayko/git-sh) ⚠️ Archived - A customized Bash environment suitable for Git work
* [add-gitignore](https://github.com/TejasQ/add-gitignore) ⭐ 731 | 🐛 5 | 🌐 JavaScript | 📅 2023-11-20 - Interactive CLI that generates a .gitignore for your project based on your needs.
...
* [vmn](https://github.com/final-israel/vmn) ⭐ 67 | 🐛 41 | 🌐 Python | 📅 2026-09-22 - git-based automatic versioning and state recovery solution agnostic to language or architecture
...
* [bat](https://github.com/sharkdp/bat) ⭐ 60,545 | 🐛 517 | 🌐 Rust | 📅 2026-09-22 - A `cat` clone with wings
* [btop](https://github.com/aristocratos/btop) ⭐ 34,709 | 🐛 545 | 🌐 C++ | 📅 2026-09-19 - Linux/OSX/FreeBSD resource monitor
* [glances](https://github.com/nicolargo/glances) ⭐ 33,650 | 🐛 106 | 🌐 Python | 📅 2026-09-22 - Glances an Eye on your system
* [exa](https://github.com/ogham/exa) ⭐ 24,443 | 🐛 213 | 🌐 Rust | 📅 2024-09-24 - A modern version of `ls`.
* [goaccess](https://github.com/allinurl/goaccess) ⭐ 20,943 | 🐛 449 | 🌐 C | 📅 2026-09-19 - GoAccess is a real-time web log analyzer and interactive viewer that runs in a terminal in \*nix systems.
* [lsd](https://github.com/Peltoche/lsd) ⭐ 16,238 | 🐛 210 | 🌐 Rust | 📅 2026-08-17 - LSDeluxe, rewrite of GNU ls with lot of added features like colors, icons, tree-view and more formatting options.
* [progress](https://github.com/Xfennec/progress) ⭐ 8,854 | 🐛 66 | 🌐 C | 📅 2024-11-19 - Linux tool to show progress for `cp`, `rm`, `dd`, and more...
...
* [bmon](https://github.com/tgraf/bmon) ⭐ 1,391 | 🐛 37 | 🌐 C | 📅 2026-09-19 - Real-time network bandwidth monitor and rate estimator with human-friendly visual output
* [powertop](https://github.com/fenrus75/powertop) ⭐ 1,338 | 🐛 102 | 🌐 C++ | 📅 2026-09-15 - Battery/Power usage and device stats monitoring command-line tool, with tune-up options.
...
* [nmtui](https://github.com/NetworkManager/NetworkManager) ⭐ 507 | 🐛 0 | 🌐 C | 📅 2026-09-22 - Text User Interface for controlling NetworkManager
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 192,936 | 🐛 2,665 | 🌐 Python | 📅 2026-09-16 - Command-line program to download videos from YouTube.com and other video sites
* [aria2](https://github.com/aria2/aria2) ⭐ 42,629 | 🐛 1,178 | 🌐 C++ | 📅 2026-06-25 - aria2 is a lightweight multi-protocol & multi-source, cross platform download utility operated in command-line. It supports HTTP/HTTPS, FTP, BitTorrent and Metalink
* [httpie](https://github.com/httpie/httpie) ⭐ 38,561 | 🐛 336 | 🌐 Python | 📅 2024-12-17 - HTTPie is a command line HTTP client, a user-friendly cURL replacement
* [xh](https://github.com/ducaale/xh) ⭐ 8,087 | 🐛 37 | 🌐 Rust | 📅 2026-09-05 - Friendly and fast tool for sending HTTP requests
...
* [jq](https://github.com/stedolan/jq) ⭐ 35,667 | 🐛 450 | 🌐 C | 📅 2026-09-19 - Sed for json data. You can use it to slice and filter and map and transform structured data
* [fx](https://github.com/antonmedv/fx) ⭐ 20,637 | 🐛 34 | 🌐 Go | 📅 2026-08-26 - Command-line JSON processing tool by anononymus JavaScript functions
* [yq](https://github.com/mikefarah/yq) ⭐ 15,998 | 🐛 302 | 🌐 Go | 📅 2026-09-22 - yq is a portable command-line YAML processor
* [Beets](https://github.com/beetbox/beets) ⭐ 15,694 | 🐛 707 | 🌐 Python | 📅 2026-09-22 - Music library manager and MusicBrainz tagger
* [visidata](https://github.com/saulpw/visidata) ⭐ 9,292 | 🐛 89 | 🌐 Python | 📅 2026-09-21 - A terminal spreadsheet multitool for exploring and arranging data (csv/json/xml/xls/yaml/etc)
* [jc](https://github.com/kellyjonbrazil/jc) ⭐ 8,684 | 🐛 32 | 🌐 Python | 📅 2026-09-22 - Convert command output, file-types, and common strings to JSON or YAML for easier use in scripts.
* [dasel](https://github.com/tomwright/dasel) ⭐ 8,039 | 🐛 25 | 🌐 Go | 📅 2026-08-16 - Query and update data structures using selectors from the command line. Comparable to [jq](https://github.com/stedolan/jq) ⭐ 35,667 | 🐛 450 | 🌐 C | 📅 2026-09-19 / [yq](https://github.com/kislyuk/yq) ⭐ 2,982 | 🐛 22 | 🌐 Python | 📅 2026-09-19 but supports JSON, YAML, TOML and XML with zero runtime dependencies.
* [cmus](https://github.com/cmus/cmus) ⭐ 6,248 | 🐛 221 | 🌐 C | 📅 2026-08-12 - Cross-platform cli audio player.
...
* [wttr.in](https://github.com/chubin/wttr.in) ⭐ 30,577 | 🐛 331 | 🌐 Go | 📅 2026-09-07 - :partly\_sunny: The right way to check the weather (curl wttr.in)
...
* [jrnl](https://github.com/jrnl-org/jrnl) ⭐ 7,322 | 🐛 152 | 🌐 Python | 📅 2026-09-22 - A simple command line journal application that stores your journal in a plain text file
* [ticker](https://github.com/achannarasappa/ticker) ⭐ 6,237 | 🐛 34 | 🌐 Go | 📅 2026-06-28 — Terminal stock ticker with live updates and position tracking
* [ledger](https://github.com/ledger/ledger) ⭐ 6,041 | 🐛 17 | 🌐 C++ | 📅 2026-09-22 - Command line accounting
...
* [gcalcli](https://github.com/insanum/gcalcli) ⭐ 3,767 | 🐛 170 | 🌐 Python | 📅 2025-10-25 - Google Calendar command line interface
...
* [bash-it](https://github.com/Bash-it/bash-it) ⭐ 15,235 | 🐛 6 | 🌐 Shell | 📅 2026-09-13 - A community Bash framework
...
* [dotdrop](https://github.com/deadc0de6/dotdrop) ⭐ 1,949 | 🐛 3 | 🌐 Python | 📅 2026-09-22 - Save your dotfiles once, deploy them everywhere
* [shallow-backup](https://github.com/alichtman/shallow-backup) ⭐ 1,335 | 🐛 23 | 🌐 Python | 📅 2026-03-21 - Easily create lightweight documentation of installed packages, dotfiles, and more
...
* [shellcheck](https://github.com/koalaman/shellcheck) ⭐ 40,069 | 🐛 1,134 | 🌐 Haskell | 📅 2026-09-21 - Static analysis tool for shell scripts
* [shfmt](https://github.com/mvdan/sh) ⭐ 9,078 | 🐛 93 | 🌐 Go | 📅 2026-09-22 - A shell parser, formatter, and interpreter with bash support; includes shfmt
* [bats](https://github.com/bats-core/bats-core) ⭐ 6,277 | 🐛 122 | 🌐 Shell | 📅 2026-09-21 - Bash Automated Testing System
* [bash-language-server](https://github.com/bash-lsp/bash-language-server) ⭐ 2,780 | 🐛 67 | 🌐 TypeScript | 📅 2026-09-22 - [LSP](https://microsoft.github.io/language-server-protocol/)-based Bash language server
...
* [is.sh](https://github.com/qzb/is.sh) ⭐ 175 | 🐛 5 | 🌐 Shell | 📅 2019-11-20 - An alternative for builtin test command, it will make your "if" statements pretty
...
* [The Art of Command Line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,486 | 🐛 256 | 📅 2024-06-25
...
Other amazingly awesome lists can be found in [awesome-awesome](https://github.com/emijrp/awesome-awesome) ⭐ 3,212 | 🐛 26 | 📅 2024-07-31 and [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,681 | 🐛 66 | 🌐 Ruby | 📅 2024-06-02.

### See also

* [awesome-cli-apps](https://github.com/agarrharr/awesome-cli-apps) ⭐ 20,446 | 🐛 0 | 🌐 Shell | 📅 2026-09-21
* [terminals-are-sexy](https://github.com/k4m4/terminals-are-sexy) ⭐ 13,127 | 🐛 155 | 🌐 Shell | 📅 2024-07-26
