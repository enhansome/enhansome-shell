...
* [nushell](https://github.com/nushell/nushell) ⭐ 40,395 | 🐛 1,442 | 🌐 Rust | 📅 2026-09-01 - A modern shell written in Rust
...
* [ngs](https://github.com/ngs-lang/ngs) ⭐ 1,520 | 🐛 303 | 🌐 C | 📅 2026-08-28 - Fully featured scripting language created specifically for Ops. REPL is being developed.
* [ksh93](https://github.com/att/ast) ⚠️ Archived - Korn Shell
* [yash](https://github.com/magicant/yash) ⭐ 563 | 🐛 45 | 🌐 Shell | 📅 2026-09-01 - A POSIX-compliant command line shell with built-in support for completion and prediction based on command history
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 82,769 | 🐛 327 | 🌐 Go | 📅 2026-08-31 - A command-line fuzzy finder
* [rg](https://github.com/BurntSushi/ripgrep) ⭐ 67,826 | 🐛 184 | 🌐 Rust | 📅 2026-08-04 - ripgrep is a line oriented search tool that combines the usability of The Silver Searcher with the raw speed of GNU grep
* [fd](https://github.com/sharkdp/fd) ⭐ 44,276 | 🐛 202 | 🌐 Rust | 📅 2026-09-01 - A simple, fast and user-friendly alternative to find.
* [ag](https://github.com/ggreer/the_silver_searcher) ⭐ 27,112 | 🐛 564 | 🌐 C | 📅 2024-06-16 - Super fast string search through a directory hierarchy
* [nnn](https://github.com/jarun/nnn) ⭐ 21,855 | 🐛 4 | 🌐 C | 📅 2026-09-01 - File browser and disk usage analyzer with excellent desktop integration
* [browsh](https://github.com/browsh-org/browsh) ⭐ 19,017 | 🐛 241 | 🌐 JavaScript | 📅 2025-07-11 - The modern text-based browser
* [navi](https://github.com/denisidoro/navi) ⭐ 17,499 | 🐛 111 | 🌐 Rust | 📅 2026-07-28 - An interactive cheatsheet tool for the command-line
* [direnv](https://github.com/direnv/direnv) ⭐ 15,405 | 🐛 464 | 🌐 Go | 📅 2026-03-31 - An environment switcher for the shell, compare with autoenv
...
* [lf](https://github.com/gokcehan/lf) ⭐ 9,486 | 🐛 82 | 🌐 Go | 📅 2026-08-25 - Terminal file manager written in Go, inspired by ranger
* [mcfly](https://github.com/cantino/mcfly) ⭐ 7,784 | 🐛 134 | 🌐 Rust | 📅 2026-09-01 - Fly through your shell history. Great Scot!
* [Buku](https://github.com/jarun/Buku) ⭐ 7,187 | 🐛 6 | 🌐 Python | 📅 2026-08-16 - Powerful command-line bookmark manager
...
* [fselect](https://github.com/jhspetersson/fselect) ⭐ 4,459 | 🐛 6 | 🌐 Rust | 📅 2026-08-29 - Find files with SQL-like queries.
* [hstr](https://github.com/dvorka/hstr) ⭐ 4,454 | 🐛 185 | 🌐 C | 📅 2026-08-28 - Bash History Suggest Box
* [ddgr](https://github.com/jarun/ddgr) ⭐ 3,538 | 🐛 1 | 🌐 Python | 📅 2026-08-16 - DuckDuckGo from the terminal
...
* [k](https://github.com/supercrabtree/k) ⭐ 1,805 | 🐛 38 | 🌐 Shell | 📅 2023-02-04 - k is a Zsh script to make directory listings more readable, adding Git status, fileweight colors and rotting dates
...
* [thefuck](https://github.com/nvbn/thefuck) ⭐ 97,761 | 🐛 456 | 🌐 Python | 📅 2024-07-19 - Fix common shell mistakes by using an easy to remember command
...
* [xxh](https://github.com/xxh/xxh) ⭐ 6,079 | 🐛 30 | 🌐 Python | 📅 2026-06-02 - Bring your favorite shell wherever you go through the SSH.
...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 39,104 | 🐛 140 | 🌐 Rust | 📅 2026-08-31 - A faster way to navigate your filesystem, written in Rust
...
* [powerlevel10k](https://github.com/romkatv/powerlevel10k) ⭐ 55,010 | 🐛 150 | 🌐 Shell | 📅 2026-08-15 - Super flexible awesome powerline ZSH theme
* [Gogh - Color Scheme](https://github.com/Mayccoll/Gogh) ⭐ 10,302 | 🐛 3 | 🌐 Shell | 📅 2026-08-31 - Color Scheme for Gnome Terminal
...
* [just](https://github.com/casey/just) ⭐ 35,573 | 🐛 174 | 🌐 Rust | 📅 2026-09-01 - Task runner for saving and running project-specific commands.
* [dokku](https://github.com/dokku/dokku) ⭐ 32,122 | 🐛 41 | 🌐 Shell | 📅 2026-09-01 - Docker powered mini-Heroku. The smallest PaaS implementation you've ever seen.
* [cloc](https://github.com/AlDanial/cloc) ⭐ 23,491 | 🐛 27 | 🌐 Perl | 📅 2026-08-08 - Count Lines of Code
...
* [forgit](https://github.com/wfxr/forgit) ⭐ 5,072 | 🐛 12 | 🌐 Shell | 📅 2026-09-01 - Utility tool for `git` taking advantage of fuzzy finder fzf.
...
* [gita](https://github.com/nosarthur/gita) ⭐ 1,933 | 🐛 36 | 🌐 Python | 📅 2026-07-06 - A command-line tool to manage multiple git repos.
...
* [bat](https://github.com/sharkdp/bat) ⭐ 60,333 | 🐛 422 | 🌐 Rust | 📅 2026-09-01 - A `cat` clone with wings
* [btop](https://github.com/aristocratos/btop) ⭐ 34,358 | 🐛 530 | 🌐 C++ | 📅 2026-09-01 - Linux/OSX/FreeBSD resource monitor
* [glances](https://github.com/nicolargo/glances) ⭐ 33,499 | 🐛 102 | 🌐 Python | 📅 2026-08-30 - Glances an Eye on your system
* [exa](https://github.com/ogham/exa) ⭐ 24,445 | 🐛 213 | 🌐 Rust | 📅 2024-09-24 - A modern version of `ls`.
* [goaccess](https://github.com/allinurl/goaccess) ⭐ 20,890 | 🐛 449 | 🌐 C | 📅 2026-08-31 - GoAccess is a real-time web log analyzer and interactive viewer that runs in a terminal in \*nix systems.
* [lsd](https://github.com/Peltoche/lsd) ⭐ 16,204 | 🐛 205 | 🌐 Rust | 📅 2026-08-17 - LSDeluxe, rewrite of GNU ls with lot of added features like colors, icons, tree-view and more formatting options.
...
* [powertop](https://github.com/fenrus75/powertop) ⭐ 1,333 | 🐛 104 | 🌐 C++ | 📅 2026-09-01 - Battery/Power usage and device stats monitoring command-line tool, with tune-up options.
...
* [nmtui](https://github.com/NetworkManager/NetworkManager) ⭐ 505 | 🐛 2 | 🌐 C | 📅 2026-09-01 - Text User Interface for controlling NetworkManager
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 188,352 | 🐛 2,615 | 🌐 Python | 📅 2026-08-30 - Command-line program to download videos from YouTube.com and other video sites
* [aria2](https://github.com/aria2/aria2) ⭐ 41,894 | 🐛 1,175 | 🌐 C++ | 📅 2026-06-25 - aria2 is a lightweight multi-protocol & multi-source, cross platform download utility operated in command-line. It supports HTTP/HTTPS, FTP, BitTorrent and Metalink
* [httpie](https://github.com/httpie/httpie) ⭐ 38,477 | 🐛 336 | 🌐 Python | 📅 2024-12-17 - HTTPie is a command line HTTP client, a user-friendly cURL replacement
...
* [bashhub-server](https://github.com/nicksherron/bashhub-server) ⭐ 321 | 🐛 13 | 🌐 Go | 📅 2023-03-30 - Private cloud shell history. Open source server for bashhub
...
* [jq](https://github.com/stedolan/jq) ⭐ 35,525 | 🐛 475 | 🌐 C | 📅 2026-09-01 - Sed for json data. You can use it to slice and filter and map and transform structured data
* [fx](https://github.com/antonmedv/fx) ⭐ 20,616 | 🐛 27 | 🌐 Go | 📅 2026-08-26 - Command-line JSON processing tool by anononymus JavaScript functions
* [yq](https://github.com/mikefarah/yq) ⭐ 15,913 | 🐛 292 | 🌐 Go | 📅 2026-08-27 - yq is a portable command-line YAML processor
* [Beets](https://github.com/beetbox/beets) ⭐ 15,606 | 🐛 716 | 🌐 Python | 📅 2026-09-01 - Music library manager and MusicBrainz tagger
* [visidata](https://github.com/saulpw/visidata) ⭐ 9,261 | 🐛 80 | 🌐 Python | 📅 2026-08-28 - A terminal spreadsheet multitool for exploring and arranging data (csv/json/xml/xls/yaml/etc)
...
* [cmus](https://github.com/cmus/cmus) ⭐ 6,234 | 🐛 219 | 🌐 C | 📅 2026-08-12 - Cross-platform cli audio player.
...
* [wttr.in](https://github.com/chubin/wttr.in) ⭐ 30,472 | 🐛 330 | 🌐 Go | 📅 2026-08-02 - :partly\_sunny: The right way to check the weather (curl wttr.in)
* [ranger](https://github.com/ranger/ranger) ⭐ 17,383 | 🐛 897 | 🌐 Python | 📅 2026-08-31 - A console file manager with VI key bindings.
...
* [jrnl](https://github.com/jrnl-org/jrnl) ⭐ 7,305 | 🐛 151 | 🌐 Python | 📅 2026-08-31 - A simple command line journal application that stores your journal in a plain text file
...
* [ledger](https://github.com/ledger/ledger) ⭐ 6,024 | 🐛 19 | 🌐 C++ | 📅 2026-08-28 - Command line accounting
* [editly](https://github.com/mifi/editly) ⭐ 5,480 | 🐛 80 | 🌐 TypeScript | 📅 2025-05-12 - Command line video editor
...
* [shellcheck](https://github.com/koalaman/shellcheck) ⭐ 39,973 | 🐛 1,138 | 🌐 Haskell | 📅 2026-08-04 - Static analysis tool for shell scripts
* [shfmt](https://github.com/mvdan/sh) ⭐ 9,033 | 🐛 93 | 🌐 Go | 📅 2026-08-31 - A shell parser, formatter, and interpreter with bash support; includes shfmt
...
* [The Art of Command Line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,207 | 🐛 257 | 📅 2024-06-25
...
Other amazingly awesome lists can be found in [awesome-awesome](https://github.com/emijrp/awesome-awesome) ⭐ 3,205 | 🐛 26 | 📅 2024-07-31 and [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,638 | 🐛 62 | 🌐 Ruby | 📅 2024-06-02.

### See also

* [awesome-cli-apps](https://github.com/agarrharr/awesome-cli-apps) ⭐ 20,300 | 🐛 2 | 🌐 Shell | 📅 2026-09-01
* [terminals-are-sexy](https://github.com/k4m4/terminals-are-sexy) ⭐ 13,103 | 🐛 150 | 🌐 Shell | 📅 2024-07-26
