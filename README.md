...
* [nushell](https://github.com/nushell/nushell) ⭐ 40,278 | 🐛 1,423 | 🌐 Rust | 📅 2026-08-16 - A modern shell written in Rust
* [murex](https://github.com/lmorg/murex) ⭐ 1,905 | 🐛 84 | 🌐 Go | 📅 2026-07-29 - A smarter shell and scripting environment with advanced features designed for usability, safety and productivity (eg smarter DevOps tooling)
...
* [rg](https://github.com/BurntSushi/ripgrep) ⭐ 67,352 | 🐛 177 | 🌐 Rust | 📅 2026-08-04 - ripgrep is a line oriented search tool that combines the usability of The Silver Searcher with the raw speed of GNU grep
...
* [nnn](https://github.com/jarun/nnn) ⭐ 21,801 | 🐛 4 | 🌐 C | 📅 2026-08-17 - File browser and disk usage analyzer with excellent desktop integration
* [browsh](https://github.com/browsh-org/browsh) ⭐ 18,985 | 🐛 241 | 🌐 JavaScript | 📅 2025-07-11 - The modern text-based browser
* [navi](https://github.com/denisidoro/navi) ⭐ 17,447 | 🐛 110 | 🌐 Rust | 📅 2026-07-28 - An interactive cheatsheet tool for the command-line
* [direnv](https://github.com/direnv/direnv) ⭐ 15,368 | 🐛 459 | 🌐 Go | 📅 2026-03-31 - An environment switcher for the shell, compare with autoenv
* [mackup](https://github.com/lra/mackup/) ⭐ 15,307 | 🐛 295 | 🌐 Python | 📅 2026-06-15 - Keep your application settings in sync (OS X/Linux)
* [broot](https://github.com/Canop/broot) ⭐ 12,895 | 🐛 236 | 🌐 Rust | 📅 2026-08-16 - A better way to navigate directories
* [lf](https://github.com/gokcehan/lf) ⭐ 9,463 | 🐛 80 | 🌐 Go | 📅 2026-08-15 - Terminal file manager written in Go, inspired by ranger
...
* [how2](https://github.com/santinic/how2) ⭐ 5,773 | 🐛 6 | 🌐 JavaScript | 📅 2023-03-15 - `how2` finds the simplest way to do something in a unix shell. It's like `man`, but you can query it in natural language.
...
* [fselect](https://github.com/jhspetersson/fselect) ⭐ 4,457 | 🐛 6 | 🌐 Rust | 📅 2026-08-16 - Find files with SQL-like queries.
* [hstr](https://github.com/dvorka/hstr) ⭐ 4,448 | 🐛 185 | 🌐 C | 📅 2026-05-29 - Bash History Suggest Box
* [ddgr](https://github.com/jarun/ddgr) ⭐ 3,527 | 🐛 1 | 🌐 Python | 📅 2026-08-16 - DuckDuckGo from the terminal
...
* [arttime](https://github.com/reportaman/arttime) ⭐ 1,375 | 🐛 6 | 🌐 Shell | 📅 2026-08-17 - Beauty of text art meets functionality of clock, timer, pomodoro++ time manager
...
* [thefuck](https://github.com/nvbn/thefuck) ⭐ 97,712 | 🐛 454 | 🌐 Python | 📅 2024-07-19 - Fix common shell mistakes by using an easy to remember command
* [xsv](https://github.com/BurntSushi/xsv) ⚠️ Archived - a fast CSV command line toolkit written in Rust
* [usql](https://github.com/xo/usql) ⭐ 10,078 | 🐛 119 | 🌐 Go | 📅 2026-06-19 - Universal command-line interface for SQL databases.
* [xxh](https://github.com/xxh/xxh) ⭐ 6,069 | 🐛 30 | 🌐 Python | 📅 2026-06-02 - Bring your favorite shell wherever you go through the SSH.
...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 38,689 | 🐛 138 | 🌐 Rust | 📅 2026-08-10 - A faster way to navigate your filesystem, written in Rust
* [z](https://github.com/rupa/z) ⭐ 17,037 | 🐛 107 | 🌐 Shell | 📅 2024-06-19 - z is the new j, yo
...
* [powerlevel10k](https://github.com/romkatv/powerlevel10k) ⭐ 54,924 | 🐛 150 | 🌐 Shell | 📅 2026-08-15 - Super flexible awesome powerline ZSH theme
* [Gogh - Color Scheme](https://github.com/Mayccoll/Gogh) ⭐ 10,292 | 🐛 3 | 🌐 Shell | 📅 2026-08-16 - Color Scheme for Gnome Terminal
...
* [liquidprompt](https://github.com/nojhan/liquidprompt) ⭐ 4,673 | 🐛 30 | 🌐 Shell | 📅 2026-08-13 - A full-featured & carefully designed adaptive prompt for Bash & Zsh
...
* [just](https://github.com/casey/just) ⭐ 35,327 | 🐛 168 | 🌐 Rust | 📅 2026-08-12 - Task runner for saving and running project-specific commands.
* [dokku](https://github.com/dokku/dokku) ⭐ 32,099 | 🐛 32 | 🌐 Shell | 📅 2026-08-17 - Docker powered mini-Heroku. The smallest PaaS implementation you've ever seen.
* [cloc](https://github.com/AlDanial/cloc) ⭐ 23,441 | 🐛 26 | 🌐 Perl | 📅 2026-08-08 - Count Lines of Code
* [hub](https://github.com/github/hub) ⭐ 22,957 | 🐛 294 | 🌐 Go | 📅 2024-02-02 - hub helps you win at git.
* [git-extras](https://github.com/tj/git-extras) ⭐ 18,093 | 🐛 96 | 🌐 Shell | 📅 2026-08-17 - Git utilities -- repo summary, repl, changelog population, author commit percentages and more
* [bocker](https://github.com/p8952/bocker) ⭐ 12,664 | 🐛 15 | 🌐 Shell | 📅 2017-12-09 - Docker implemented in 100 lines of bash
* [git-quick-stats](https://github.com/arzzen/git-quick-stats) ⭐ 6,997 | 🐛 3 | 🌐 Shell | 📅 2026-04-18 - Git quick statistics is a simple and efficient way to access various statistics in git repository.
...
* [forgit](https://github.com/wfxr/forgit) ⭐ 5,062 | 🐛 13 | 🌐 Shell | 📅 2026-08-01 - Utility tool for `git` taking advantage of fuzzy finder fzf.
...
* [git-extra-commands](https://github.com/unixorn/git-extra-commands) ⭐ 1,171 | 🐛 8 | 🌐 Shell | 📅 2026-08-17 - Many Git extra utilities. Churn, cut-branch, improved-merge and many more.
...
* [bitwise](https://github.com/mellowcandle/bitwise) ⭐ 721 | 🐛 13 | 🌐 C | 📅 2026-08-17 - Terminal based interactive bit manipulator in curses.
...
* [bat](https://github.com/sharkdp/bat) ⭐ 60,196 | 🐛 420 | 🌐 Rust | 📅 2026-08-11 - A `cat` clone with wings
* [btop](https://github.com/aristocratos/btop) ⭐ 34,035 | 🐛 528 | 🌐 C++ | 📅 2026-08-08 - Linux/OSX/FreeBSD resource monitor
* [glances](https://github.com/nicolargo/glances) ⭐ 33,366 | 🐛 106 | 🌐 Python | 📅 2026-08-17 - Glances an Eye on your system
* [exa](https://github.com/ogham/exa) ⭐ 24,441 | 🐛 213 | 🌐 Rust | 📅 2024-09-24 - A modern version of `ls`.
* [goaccess](https://github.com/allinurl/goaccess) ⭐ 20,827 | 🐛 455 | 🌐 C | 📅 2026-08-05 - GoAccess is a real-time web log analyzer and interactive viewer that runs in a terminal in \*nix systems.
* [lsd](https://github.com/Peltoche/lsd) ⭐ 16,174 | 🐛 205 | 🌐 Rust | 📅 2026-08-17 - LSDeluxe, rewrite of GNU ls with lot of added features like colors, icons, tree-view and more formatting options.
...
* [mtr](https://github.com/traviscross/mtr) ⭐ 3,337 | 🐛 137 | 🌐 C | 📅 2026-06-16 - The functionality of the 'traceroute' and 'ping' programs in a single network diagnostic tool.
...
* [nmtui](https://github.com/NetworkManager/NetworkManager) ⭐ 502 | 🐛 2 | 🌐 C | 📅 2026-08-13 - Text User Interface for controlling NetworkManager
...
* [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 185,070 | 🐛 2,595 | 🌐 Python | 📅 2026-08-17 - Command-line program to download videos from YouTube.com and other video sites
* [aria2](https://github.com/aria2/aria2) ⭐ 41,733 | 🐛 1,159 | 🌐 C++ | 📅 2026-06-25 - aria2 is a lightweight multi-protocol & multi-source, cross platform download utility operated in command-line. It supports HTTP/HTTPS, FTP, BitTorrent and Metalink
* [httpie](https://github.com/httpie/httpie) ⭐ 38,428 | 🐛 330 | 🌐 Python | 📅 2024-12-17 - HTTPie is a command line HTTP client, a user-friendly cURL replacement
* [xh](https://github.com/ducaale/xh) ⭐ 8,022 | 🐛 38 | 🌐 Rust | 📅 2026-08-16 - Friendly and fast tool for sending HTTP requests
...
* [jq](https://github.com/stedolan/jq) ⭐ 35,459 | 🐛 473 | 🌐 C | 📅 2026-08-12 - Sed for json data. You can use it to slice and filter and map and transform structured data
...
* [yq](https://github.com/mikefarah/yq) ⭐ 15,842 | 🐛 288 | 🌐 Go | 📅 2026-08-06 - yq is a portable command-line YAML processor
* [Beets](https://github.com/beetbox/beets) ⭐ 15,551 | 🐛 706 | 🌐 Python | 📅 2026-08-17 - Music library manager and MusicBrainz tagger
* [visidata](https://github.com/saulpw/visidata) ⭐ 9,244 | 🐛 76 | 🌐 Python | 📅 2026-08-15 - A terminal spreadsheet multitool for exploring and arranging data (csv/json/xml/xls/yaml/etc)
* [jc](https://github.com/kellyjonbrazil/jc) ⭐ 8,664 | 🐛 59 | 🌐 Python | 📅 2026-06-18 - Convert command output, file-types, and common strings to JSON or YAML for easier use in scripts.
* [dasel](https://github.com/tomwright/dasel) ⭐ 8,018 | 🐛 26 | 🌐 Go | 📅 2026-08-16 - Query and update data structures using selectors from the command line. Comparable to [jq](https://github.com/stedolan/jq) ⭐ 35,459 | 🐛 473 | 🌐 C | 📅 2026-08-12 / [yq](https://github.com/kislyuk/yq) ⭐ 2,966 | 🐛 23 | 🌐 Python | 📅 2026-07-11 but supports JSON, YAML, TOML and XML with zero runtime dependencies.
* [cmus](https://github.com/cmus/cmus) ⭐ 6,214 | 🐛 217 | 🌐 C | 📅 2026-08-12 - Cross-platform cli audio player.
...
* [wttr.in](https://github.com/chubin/wttr.in) ⭐ 30,360 | 🐛 330 | 🌐 Go | 📅 2026-08-02 - :partly\_sunny: The right way to check the weather (curl wttr.in)
* [ranger](https://github.com/ranger/ranger) ⭐ 17,349 | 🐛 897 | 🌐 Python | 📅 2026-08-15 - A console file manager with VI key bindings.
...
* [jrnl](https://github.com/jrnl-org/jrnl) ⭐ 7,293 | 🐛 149 | 🌐 Python | 📅 2026-08-14 - A simple command line journal application that stores your journal in a plain text file
* [ticker](https://github.com/achannarasappa/ticker) ⭐ 6,201 | 🐛 36 | 🌐 Go | 📅 2026-06-28 — Terminal stock ticker with live updates and position tracking
...
* [shellcheck](https://github.com/koalaman/shellcheck) ⭐ 39,886 | 🐛 1,137 | 🌐 Haskell | 📅 2026-08-04 - Static analysis tool for shell scripts
* [shfmt](https://github.com/mvdan/sh) ⭐ 8,986 | 🐛 98 | 🌐 Go | 📅 2026-08-13 - A shell parser, formatter, and interpreter with bash support; includes shfmt
* [bats](https://github.com/bats-core/bats-core) ⭐ 6,219 | 🐛 124 | 🌐 Shell | 📅 2026-07-26 - Bash Automated Testing System
* [bash-language-server](https://github.com/bash-lsp/bash-language-server) ⭐ 2,769 | 🐛 134 | 🌐 TypeScript | 📅 2026-08-16 - [LSP](https://microsoft.github.io/language-server-protocol/)-based Bash language server
...
* [A guide to learn bash](https://github.com/Idnan/bash-guide) ⭐ 12,370 | 🐛 27 | 📅 2024-08-11
...
* [terminals-are-sexy](https://github.com/k4m4/terminals-are-sexy) ⭐ 13,078 | 🐛 148 | 🌐 Shell | 📅 2024-07-26
